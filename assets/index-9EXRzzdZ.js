...
<a href="mailto:pp3ng@outlook.com">Email: Pp3ng@outlook.com</a>`,clear:()=>(l(g),null),goto:S=>{const b=document.getElementById(S);if(b){const C=document.querySelector(".navbar"),k=(C==null?void 0:C.offsetHeight)||0;return window.scrollTo({top:b.offsetTop-k-20,behavior:"smooth"}),`Navigating to ${S}...`}else return`Section not found: ${S}. Available sections: about, terminal, journey, passions, gallery, projects, insights, bookshelf`},joke:()=>'<img src="https://readme-jokes.vercel.app/api?theme=vue" alt="Programming Joke" style="max-width: 100%; border-radius: 8px;">',cowsay:(S="Mooooo!")=>{const b=Array.isArray(S)?S.join(" "):S.toString();return`
  ${"-".repeat(b.length+2)}
< ${b} >
  ${"-".repeat(b.length+2)}
        \\   ^__^
         \\  (oo)\\_______
            (__)\\       )\\/\\
                ||----w |
                ||     ||
        `},weather:async S=>{try{if(!S)return await(await fetch("https://wttr.in/?format=3")).text();const b=await fetch(`https://wttr.in/${encodeURIComponent(S)}?format=3`);if(!b.ok)throw new Error("Weather service error");return await b.text()}catch{return"Failed to fetch weather data. Please try again later or specify a valid city name."}},crypto:async()=>{try{const b=await(await fetch("https://api.coindesk.com/v1/bpi/currentprice.json")).json(),C=b.bpi.USD.rate_float,k=b.bpi.EUR.rate_float,B=(await(await fetch("https://open.er-api.com/v6/latest/USD")).json()).rates.CNY,D=C*B;return`Bitcoin Price:
USD: $${C.toFixed(2)}
CNY: ¥${D.toFixed(2)}
EUR: €${k.toFixed(2)}`}catch{return"Failed to fetch cryptocurrency prices"}},cat:async()=>{try{return`<div style="margin: 10px 0;">
                ...
                </div>`}catch{return"Failed to fetch dog picture"}},nasa:async()=>{try{const b=await(await fetch("https://api.nasa.gov/planetary/apod?api_key=DEMO_KEY")).json();return`NASA Astronomy Picture of the Day:
Title: ${b.title}
Date: ${b.date}
<div style="margin: 10px 0;">
    <img src="${b.url}" alt="${b.title}" style="max-width: 100%; max-height: 300px; border-radius: 5px; border: 3px solid rgba(255, 255, 255, 0.4);">
</div>
${b.explanation.slice(0,200)}...`}catch{return"Failed to fetch NASA picture of the day"}},fact:async()=>{try{return`Random Fact: ${(await(await fetch("https://uselessfacts.jsph.pl/random.json?language=en")).json()).text}`}catch{return"Failed to fetch random fact"}},date:()=>{const S=new Date,b=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],C=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];return`${b[S.getDay()]} ${C[S.getMonth()]} ${S.getDate()} ${S.toTimeString().slice(0,8)} KST ${S.getFullYear()}`},history:()=>t.map((S,b)=>` ${b+1}  ${S}`).join(`
`),neofetch:()=>{const S=new Date("2024-09-28"),C=Math.floor((new Date().getTime()-S.getTime())/(1e3*60*60*24)),k=navigator.language||"en-US",I=()=>{const D=navigator.userAgent;return D.includes("Firefox")?"Browser (Firefox)":D.includes("Chrome")&&!D.includes("Edg")?"Browser (Chrome)":D.includes("Safari")&&!D.includes("Chrome")?"Browser (Safari)":D.includes("Edg")?"Browser (Edge)":D.includes("OPR")?"Browser (Opera)":"Browser (Other)"},f=["Time to code and conquer!","Coffee level: Critical","Bug hunting in progress...","System status: Awesome","Ready to debug!"];return`
                       ...
                       (  \\_     _/  )           Shell: Terminal.js v3.14 <i class="fas fa-terminal"></i>
                        \`-\\_____/--'             Resolution: ${window.screen.width}x${window.screen.height} <i class="fas fa-desktop"></i>
                                                 ...
                                                 Battery: Coffee 99% <i class="fas fa-coffee"></i>`},advice:async()=>{try{const b=await(await fetch("https://api.adviceslip.com/advice")).json();return`💡 Advice #${b.slip.id}: ${b.slip.advice}`}catch{return"Failed to fetch advice. Maybe that's the advice: sometimes things fail."}},word:async()=>{var S,b,C,k;try{const I=await fetch("https://random-word-api.herokuapp.com/word"),[f]=await I.json(),B=await fetch(`https://api.dictionaryapi.dev/api/v2/entries/en/${f}`);if(!B.ok)return`Random Word: ${f}
Definition: No definition found for this random word.`;const D=await B.json();let N=`📚 Random Word: ${f}

`;if(((b=(S=D[0])==null?void 0:S.meanings)==null?void 0:b.length)>0){const O=D[0].meanings[0],q=O.partOfSpeech,W=((C=O.definitions[0])==null?void 0:C.definition)||"No definition available";N+=`Part of Speech: ${q}
Definition: ${W}`,(k=O.definitions[0])!=null&&k.example&&(N+=`

Example: "${O.definitions[0].example}"`)}else N+="No definition found for this random word.";return N}catch{return"Failed to fetch a random word. Please try again later."}}},y=async S=>{if(!S.trim())return"";const b=S.split(" "),C=b[0],k=b.slice(1);if(v[C]){if(C==="cowsay")return v[C](k.join(" "));const I=v[C](...k);return I instanceof Promise?await I:I}else if(S.trim()!=="")return`Command not found: ${S}. Type 'help' for available commands.`;return""},M=()=>window.innerWidth<=768,A=()=>{u.current&&(u.current.scrollTop=u.current.scrollHeight)},E=async S=>{if(S.key==="Enter"){const b=r.trim();if(b){e(k=>[...k,b]),i(t.length+1);const C=await y(b);C!==null&&l(k=>`${k}>_ ${b}
${C||""}

`)}s(""),A()}else if(S.key==="ArrowUp"){if(S.preventDefault(),t.length>0&&n>0){const b=n-1;i(b),s(t[b])}}else if(S.key==="ArrowDown")if(S.preventDefault(),n<t.length-1){const b=n+1;i(b),s(t[b])}else i(t.length),s("");else if(S.key==="Tab"){S.preventDefault();const b=r,C=Object.keys(v).filter(k=>k.startsWith(b.split(" ")[0]));C.length===1?s(C[0]+(b.includes(" ")?b.substring(b.indexOf(" ")):"")):C.length>1&&(l(k=>`${k}>_ ${b}
${C.join("  ")}

`),A())}else S.key==="c"&&S.ctrlKey?(S.preventDefault(),s(""),l(b=>`${b}>_ ^C
 ...
 */var Fm;function NS(){return Fm||(Fm=1,function(t){(function(e,n){t.exports=e.document?n(e,!0):function(i){if(!i.document)throw new Error("jQuery requires a window with a document");return n(i)}})(typeof window<"u"?window:fh,function(e,n){var i=[],r=Object.getPrototypeOf,s=i.slice,a=i.flat?function(o){return i.flat.call(o)}:function(o){return i.concat.apply([],o)},l=i.push,u=i.indexOf,d={},m=d.toString,g=d.hasOwnProperty,v=g.toString,y=v.call(Object),M={},A=function(c){return typeof c=="function"&&typeof c.nodeType!="number"&&typeof c.item!="function"},E=function(c){return c!=null&&c===c.window},h=e.document,S={type:!0,src:!0,nonce:!0,noModule:!0};function b(o,c,p){p=p||h;var _,w,T=p.createElement("script");if(T.text=o,c)for(_ in S)w=c[_]||c.getAttribute&&c.getAttribute(_),w&&T.setAttribute(_,w);p.head.appendChild(T).parentNode.removeChild(T)}function C(o){return o==null?o+"":typeof o=="object"||typeof o=="function"?d[m.call(o)]||"object":typeof o}var k="3.7.1",I=/HTML$/i,f=function(o,c){return new f.fn.init(o,c)};f.fn=f.prototype={jquery:k,constructor:f,length:0,toArray:function(){return s.call(this)},get:function(o){return o==null?s.call(this):o<0?this[o+this.length]:this[o]},pushStack:function(o){var c=f.merge(this.constructor(),o);return c.prevObject=this,c},each:function(o){return f.each(this,o)},map:function(o){return this.pushStack(f.map(this,function(c,p){return o.call(c,p,c)}))},slice:function(){return this.pushStack(s.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},even:function(){return this.pushStack(f.grep(this,function(o,c){return(c+1)%2}))},odd:function(){return this.pushStack(f.grep(this,function(o,c){return c%2}))},eq:function(o){var c=this.length,p=+o+(o<0?c:0);return this.pushStack(p>=0&&p<c?[this[p]]:[])},end:function(){return this.prevObject||this.constructor()},push:l,sort:i.sort,splice:i.splice},f.extend=f.fn.extend=function(){var o,c,p,_,w,T,R=arguments[0]||{},j=1,z=arguments.length,X=!1;for(typeof R=="boolean"&&(X=R,R=arguments[j]||{},j++),typeof R!="object"&&!A(R)&&(R={}),j===z&&(R=this,j--);j<z;j++)if((o=arguments[j])!=null)for(c in o)_=o[c],!(c==="__proto__"||R===_)&&(X&&_&&(f.isPlainObject(_)||(w=Array.isArray(_)))?(p=R[c],w&&!Array.isArray(p)?T=[]:!w&&!f.isPlainObject(p)?T={}:T=p,w=!1,R[c]=f.extend(X,T,_)):_!==void 0&&(R[c]=_));return R},f.extend({expando:"jQuery"+(k+Math.random()).replace(/\D/g,""),isReady:!0,error:function(o){throw new Error(o)},noop:function(){},isPlainObject:function(o){var c,p;return!o||m.call(o)!=="[object Object]"?!1:(c=r(o),c?(p=g.call(c,"constructor")&&c.constructor,typeof p=="function"&&v.call(p)===y):!0)},isEmptyObject:function(o){var c;for(c in o)return!1;return!0},globalEval:function(o,c,p){b(o,{nonce:c&&c.nonce},p)},each:function(o,c){var p,_=0;if(B(o))for(p=o.length;_<p&&c.call(o[_],_,o[_])!==!1;_++);else for(_ in o)if(c.call(o[_],_,o[_])===!1)break;return o},text:function(o){var c,p="",_=0,w=o.nodeType;if(!w)for(;c=o[_++];)p+=f.text(c);return w===1||w===11?o.textContent:w===9?o.documentElement.textContent:w===3||w===4?o.nodeValue:p},makeArray:function(o,c){var p=c||[];return o!=null&&(B(Object(o))?f.merge(p,typeof o=="string"?[o]:o):l.call(p,o)),p},inArray:function(o,c,p){return c==null?-1:u.call(c,o,p)},isXMLDoc:function(o){var c=o&&o.namespaceURI,p=o&&(o.ownerDocument||o).documentElement;return!I.test(c||p&&p.nodeName||"HTML")},merge:function(o,c){for(var p=+c.length,_=0,w=o.length;_<p;_++)o[w++]=c[_];return o.length=w,o},grep:function(o,c,p){for(var _,w=[],T=0,R=o.length,j=!p;T<R;T++)_=!c(o[T],T),_!==j&&w.push(o[T]);return w},map:function(o,c,p){var _,w,T=0,R=[];if(B(o))for(_=o.length;T<_;T++)w=c(o[T],T,p),w!=null&&R.push(w);else for(T in o)w=c(o[T],T,p),w!=null&&R.push(w);return a(R)},guid:1,support:M}),typeof Symbol=="function"&&(f.fn[Symbol.iterator]=i[Symbol.iterator]),f.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(o,c){d["[object "+c+"]"]=c.toLowerCase()});function B(o){var c=!!o&&"length"in o&&o.length,p=C(o);return A(o)||E(o)?!1:p==="array"||c===0||typeof c=="number"&&c>0&&c-1 in o}function D(o,c){return o.nodeName&&o.nodeName.toLowerCase()===c.toLowerCase()}var N=i.pop,O=i.sort,q=i.splice,W="[\\x20\\t\\r\\n\\f]",ee=new RegExp("^"+W+"+|((?:^|[^\\\\])(?:\\\\.)*)"+W+"+$","g");f.contains=function(o,c){var p=c&&c.parentNode;return o===p||!!(p&&p.nodeType===1&&(o.contains?o.contains(p):o.compareDocumentPosition&&o.compareDocumentPosition(p)&16))};var he=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g;function fe(o,c){return c?o==="\0"?"�":o.slice(0,-1)+"\\"+o.charCodeAt(o.length-1).toString(16)+" ":"\\"+o}f.escapeSelector=function(o){return(o+"").replace(he,fe)};var me=h,V=l;(function(){var o,c,p,_,w,T=V,R,j,z,X,ae,pe=f.expando,te=0,Se=0,lt=ll(),Rt=ll(),pt=ll(),En=ll(),dn=function(U,G){return U===G&&(w=!0),0},Ii="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",Ui="(?:\\\\[\\da-fA-F]{1,6}"+W+"?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+",Tt="\\["+W+"*("+Ui+")(?:"+W+"*([*^$|!~]?=)"+W+`*(?:'((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)"|(`+Ui+"))|)"+W+"*\\]",as=":("+Ui+`)(?:\\((('((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|`+Tt+")*)|.*)\\)|)",Pt=new RegExp(W+"+","g"),tn=new RegExp("^"+W+"*,"+W+"*"),Ko=new RegExp("^"+W+"*([>+~]|"+W+")"+W+"*"),xu=new RegExp(W+"|>"),Fi=new RegExp(as),Zo=new RegExp("^"+Ui+"$"),ki={ID:new RegExp("^#("+Ui+")"),CLASS:new RegExp("^\\.("+Ui+")"),TAG:new RegExp("^("+Ui+"|[*])"),ATTR:new RegExp("^"+Tt),PSEUDO:new RegExp("^"+as),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+W+"*(even|odd|(([+-]|)(\\d*)n|)"+W+"*(?:([+-]|)"+W+"*(\\d+)|))"+W+"*\\)|)","i"),bool:new RegExp("^(?:"+Ii+")$","i"),needsContext:new RegExp("^"+W+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+W+"*((?:-\\d)?\\d*)"+W+"*\\)|)(?=[^-]|$)","i")},br=/^(?:input|select|textarea|button)$/i,Ar=/^h\d$/i,li=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,yu=/[+~]/,Ki=new RegExp("\\\\[\\da-fA-F]{1,6}"+W+"?|\\\\([^\\r\\n\\f])","g"),Zi=function(U,G){var Q="0x"+U.slice(1)-65536;return G||(Q<0?String.fromCharCode(Q+65536):String.fromCharCode(Q>>10|55296,Q&1023|56320))},jx=function(){Cr()},Vx=ul(function(U){return U.disabled===!0&&D(U,"fieldset")},{dir:"parentNode",next:"legend"});function Gx(){try{return R.activeElement}catch{}}try{T.apply(i=s.call(me.childNodes),me.childNodes),i[me.childNodes.length].nodeType}catch{T={apply:function(G,Q){V.apply(G,s.call(Q))},call:function(G){V.apply(G,s.call(arguments,1))}}}function Bt(U,G,Q,re){var de,Te,Ie,qe,Ue,xt,rt,ut=G&&G.ownerDocument,yt=G?G.nodeType:9;if(Q=Q||[],typeof U!="string"||!U||yt!==1&&yt!==9&&yt!==11)return Q;if(!re&&(Cr(G),G=G||R,z)){if(yt!==11&&(Ue=li.exec(U)))if(de=Ue[1]){if(yt===9)if(Ie=G.getElementById(de)){if(Ie.id===de)return T.call(Q,Ie),Q}else return Q;else if(ut&&(Ie=ut.getElementById(de))&&Bt.contains(G,Ie)&&Ie.id===de)return T.call(Q,Ie),Q}else{if(Ue[2])return T.apply(Q,G.getElementsByTagName(U)),Q;if((de=Ue[3])&&G.getElementsByClassName)return T.apply(Q,G.getElementsByClassName(de)),Q}if(!En[U+" "]&&(!X||!X.test(U))){if(rt=U,ut=G,yt===1&&(xu.test(U)||Ko.test(U))){for(ut=yu.test(U)&&Su(G.parentNode)||G,(ut!=G||!M.scope)&&((qe=G.getAttribute("id"))?qe=f.escapeSelector(qe):G.setAttribute("id",qe=pe)),xt=Qo(U),Te=xt.length;Te--;)xt[Te]=(qe?"#"+qe:":scope")+" "+cl(xt[Te]);rt=xt.join(",")}try{return T.apply(Q,ut.querySelectorAll(rt)),Q}catch{En(U,!0)}finally{qe===pe&&G.removeAttribute("id")}}}return bp(U.replace(ee,"$1"),G,Q,re)}function ll(){var U=[];function G(Q,re){return U.push(Q+" ")>c.cacheLength&&delete G[U.shift()],G[Q+" "]=re}return G}function yi(U){return U[pe]=!0,U}function Hs(U){var G=R.createElement("fieldset");try{return!!U(G)}catch{return!1}finally{G.parentNode&&G.parentNode.removeChild(G),G=null}}function Wx(U){return function(G){return D(G,"input")&&G.type===U}}function Xx(U){return function(G){return(D(G,"input")||D(G,"button"))&&G.type===U}}function wp(U){return function(G){return"form"in G?G.parentNode&&G.disabled===!1?"label"in G?"label"in G.parentNode?G.parentNode.disabled===U:G.disabled===U:G.isDisabled===U||G.isDisabled!==!U&&Vx(G)===U:G.disabled===U:"label"in G?G.disabled===U:!1}}function ls(U){return yi(function(G){return G=+G,yi(function(Q,re){for(var de,Te=U([],Q.length,G),Ie=Te.length;Ie--;)Q[de=Te[Ie]]&&(Q[de]=!(re[de]=Q[de]))})})}function Su(U){return U&&typeof U.getElementsByTagName<"u"&&U}function Cr(U){var G,Q=U?U.ownerDocument||U:me;return Q==R||Q.nodeType!==9||!Q.documentElement||(R=Q,j=R.documentElement,z=!f.isXMLDoc(R),ae=j.matches||j.webkitMatchesSelector||j.msMatchesSelector,j.msMatchesSelector&&me!=R&&(G=R.defaultView)&&G.top!==G&&G.addEventListener("unload",jx),M.getById=Hs(function(re){return j.appendChild(re).id=f.expando,!R.getElementsByName||!R.getElementsByName(f.expando).length}),M.disconnectedMatch=Hs(function(re){return ae.call(re,"*")}),M.scope=Hs(function(){return R.querySelectorAll(":scope")}),M.cssHas=Hs(function(){try{return R.querySelector(":has(*,:jqfake)"),!1}catch{return!0}}),M.getById?(c.filter.ID=function(re){var de=re.replace(Ki,Zi);return function(Te){return Te.getAttribute("id")===de}},c.find.ID=function(re,de){if(typeof de.getElementById<"u"&&z){var Te=de.getElementById(re);return Te?[Te]:[]}}):(c.filter.ID=function(re){var de=re.replace(Ki,Zi);return function(Te){var Ie=typeof Te.getAttributeNode<"u"&&Te.getAttributeNode("id");return Ie&&Ie.value===de}},c.find.ID=function(re,de){if(typeof de.getElementById<"u"&&z){var Te,Ie,qe,Ue=de.getElementById(re);if(Ue){if(Te=Ue.getAttributeNode("id"),Te&&Te.value===re)return[Ue];for(qe=de.getElementsByName(re),Ie=0;Ue=qe[Ie++];)if(Te=Ue.getAttributeNode("id"),Te&&Te.value===re)return[Ue]}return[]}}),c.find.TAG=function(re,de){return typeof de.getElementsByTagName<"u"?de.getElementsByTagName(re):de.querySelectorAll(re)},c.find.CLASS=function(re,de){if(typeof de.getElementsByClassName<"u"&&z)return de.getElementsByClassName(re)},X=[],Hs(function(re){var de;j.appendChild(re).innerHTML="<a id='"+pe+"' href='' disabled='disabled'></a><select id='"+pe+"-\r\\' disabled='disabled'><option selected=''></option></select>",re.querySelectorAll("[selected]").length||X.push("\\["+W+"*(?:value|"+Ii+")"),re.querySelectorAll("[id~="+pe+"-]").length||X.push("~="),re.querySelectorAll("a#"+pe+"+*").length||X.push(".#.+[+~]"),re.querySelectorAll(":checked").length||X.push(":checked"),de=R.createElement("input"),de.setAttribute("type","hidden"),re.appendChild(de).setAttribute("name","D"),j.appendChild(re).disabled=!0,re.querySelectorAll(":disabled").length!==2&&X.push(":enabled",":disabled"),de=R.createElement("input"),de.setAttribute("name",""),re.appendChild(de),re.querySelectorAll("[name='']").length||X.push("\\["+W+"*name"+W+"*="+W+`*(?:''|"")`)}),M.cssHas||X.push(":has"),X=X.length&&new RegExp(X.join("|")),dn=function(re,de){if(re===de)return w=!0,0;var Te=!re.compareDocumentPosition-!de.compareDocumentPosition;return Te||(Te=(re.ownerDocument||re)==(de.ownerDocument||de)?re.compareDocumentPosition(de):1,Te&1||!M.sortDetached&&de.compareDocumentPosition(re)===Te?re===R||re.ownerDocument==me&&Bt.contains(me,re)?-1:de===R||de.ownerDocument==me&&Bt.contains(me,de)?1:_?u.call(_,re)-u.call(_,de):0:Te&4?-1:1)}),R}Bt.matches=function(U,G){return Bt(U,null,null,G)},Bt.matchesSelector=function(U,G){if(Cr(U),z&&!En[G+" "]&&(!X||!X.test(G)))try{var Q=ae.call(U,G);if(Q||M.disconnectedMatch||U.document&&U.document.nodeType!==11)return Q}catch{En(G,!0)}return Bt(G,R,null,[U]).length>0},Bt.contains=function(U,G){return(U.ownerDocument||U)!=R&&Cr(U),f.contains(U,G)},Bt.attr=function(U,G){(U.ownerDocument||U)!=R&&Cr(U);var Q=c.attrHandle[G.toLowerCase()],re=Q&&g.call(c.attrHandle,G.toLowerCase())?Q(U,G,!z):void 0;return re!==void 0?re:U.getAttribute(G)},Bt.error=function(U){throw new Error("Syntax error, unrecognized expression: "+U)},f.uniqueSort=function(U){var G,Q=[],re=0,de=0;if(w=!M.sortStable,_=!M.sortStable&&s.call(U,0),O.call(U,dn),w){for(;G=U[de++];)G===U[de]&&(re=Q.push(de));for(;re--;)q.call(U,Q[re],1)}return _=null,U},f.fn.uniqueSort=function(){return this.pushStack(f.uniqueSort(s.apply(this)))},c=f.expr={cacheLength:50,createPseudo:yi,match:ki,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(U){return U[1]=U[1].replace(Ki,Zi),U[3]=(U[3]||U[4]||U[5]||"").replace(Ki,Zi),U[2]==="~="&&(U[3]=" "+U[3]+" "),U.slice(0,4)},CHILD:function(U){return U[1]=U[1].toLowerCase(),U[1].slice(0,3)==="nth"?(U[3]||Bt.error(U[0]),U[4]=+(U[4]?U[5]+(U[6]||1):2*(U[3]==="even"||U[3]==="odd")),U[5]=+(U[7]+U[8]||U[3]==="odd")):U[3]&&Bt.error(U[0]),U},PSEUDO:function(U){var G,Q=!U[6]&&U[2];return ki.CHILD.test(U[0])?null:(U[3]?U[2]=U[4]||U[5]||"":Q&&Fi.test(Q)&&(G=Qo(Q,!0))&&(G=Q.indexOf(")",Q.length-G)-Q.length)&&(U[0]=U[0].slice(0,G),U[2]=Q.slice(0,G)),U.slice(0,3))}},filter:{TAG:function(U){var G=U.replace(Ki,Zi).toLowerCase();return U==="*"?function(){return!0}:function(Q){return D(Q,G)}},CLASS:function(U){var G=lt[U+" "];return G||(G=new RegExp("(^|"+W+")"+U+"("+W+"|$)"))&&lt(U,function(Q){return G.test(typeof Q.className=="string"&&Q.className||typeof Q.getAttribute<"u"&&Q.getAttribute("class")||"")})},ATTR:function(U,G,Q){return function(re){var de=Bt.attr(re,U);return de==null?G==="!=":G?(de+="",G==="="?de===Q:G==="!="?de!==Q:G==="^="?Q&&de.indexOf(Q)===0:G==="*="?Q&&de.indexOf(Q)>-1:G==="$="?Q&&de.slice(-Q.length)===Q:G==="~="?(" "+de.replace(Pt," ")+" ").indexOf(Q)>-1:G==="|="?de===Q||de.slice(0,Q.length+1)===Q+"-":!1):!0}},CHILD:function(U,G,Q,re,de){var Te=U.slice(0,3)!=="nth",Ie=U.slice(-4)!=="last",qe=G==="of-type";return re===1&&de===0?function(Ue){return!!Ue.parentNode}:function(Ue,xt,rt){var ut,yt,tt,Wt,jn,bn=Te!==Ie?"nextSibling":"previousSibling",ci=Ue.parentNode,Oi=qe&&Ue.nodeName.toLowerCase(),js=!rt&&!qe,In=!1;if(ci){if(Te){for(;bn;){for(tt=Ue;tt=tt[bn];)if(qe?D(tt,Oi):tt.nodeType===1)return!1;jn=bn=U==="only"&&!jn&&"nextSibling"}return!0}if(jn=[Ie?ci.firstChild:ci.lastChild],Ie&&js){for(yt=ci[pe]||(ci[pe]={}),ut=yt[U]||[],Wt=ut[0]===te&&ut[1],In=Wt&&ut[2],tt=Wt&&ci.childNodes[Wt];tt=++Wt&&tt&&tt[bn]||(In=Wt=0)||jn.pop();)if(tt.nodeType===1&&++In&&tt===Ue){yt[U]=[te,Wt,In];break}}else if(js&&(yt=Ue[pe]||(Ue[pe]={}),ut=yt[U]||[],Wt=ut[0]===te&&ut[1],In=Wt),In===!1)for(;(tt=++Wt&&tt&&tt[bn]||(In=Wt=0)||jn.pop())&&!((qe?D(tt,Oi):tt.nodeType===1)&&++In&&(js&&(yt=tt[pe]||(tt[pe]={}),yt[U]=[te,In]),tt===Ue)););return In-=de,In===re||In%re===0&&In/re>=0}}},PSEUDO:function(U,G){var Q,re=c.pseudos[U]||c.setFilters[U.toLowerCase()]||Bt.error("unsupported pseudo: "+U);return re[pe]?re(G):re.length>1?(Q=[U,U,"",G],c.setFilters.hasOwnProperty(U.toLowerCase())?yi(function(de,Te){for(var Ie,qe=re(de,G),Ue=qe.length;Ue--;)Ie=u.call(de,qe[Ue]),de[Ie]=!(Te[Ie]=qe[Ue])}):function(de){return re(de,0,Q)}):re}},pseudos:{not:yi(function(U){var G=[],Q=[],re=Tu(U.replace(ee,"$1"));return re[pe]?yi(function(de,Te,Ie,qe){for(var Ue,xt=re(de,null,qe,[]),rt=de.length;rt--;)(Ue=xt[rt])&&(de[rt]=!(Te[rt]=Ue))}):function(de,Te,Ie){return G[0]=de,re(G,null,Ie,Q),G[0]=null,!Q.pop()}}),has:yi(function(U){return function(G){return Bt(U,G).length>0}}),contains:yi(function(U){return U=U.replace(Ki,Zi),function(G){return(G.textContent||f.text(G)).indexOf(U)>-1}}),lang:yi(function(U){return Zo.test(U||"")||Bt.error("unsupported lang: "+U),U=U.replace(Ki,Zi).toLowerCase(),function(G){var Q;do if(Q=z?G.lang:G.getAttribute("xml:lang")||G.getAttribute("lang"))return Q=Q.toLowerCase(),Q===U||Q.indexOf(U+"-")===0;while((G=G.parentNode)&&G.nodeType===1);return!1}}),target:function(U){var G=e.location&&e.location.hash;return G&&G.slice(1)===U.id},root:function(U){return U===j},focus:function(U){return U===Gx()&&R.hasFocus()&&!!(U.type||U.href||~U.tabIndex)},enabled:wp(!1),disabled:wp(!0),checked:function(U){return D(U,"input")&&!!U.checked||D(U,"option")&&!!U.selected},selected:function(U){return U.parentNode&&U.parentNode.selectedIndex,U.selected===!0},empty:function(U){for(U=U.firstChild;U;U=U.nextSibling)if(U.nodeType<6)return!1;return!0},parent:function(U){return!c.pseudos.empty(U)},header:function(U){return Ar.test(U.nodeName)},input:function(U){return br.test(U.nodeName)},button:function(U){return D(U,"input")&&U.type==="button"||D(U,"button")},text:function(U){var G;return D(U,"input")&&U.type==="text"&&((G=U.getAttribute("type"))==null||G.toLowerCase()==="text")},first:ls(function(){return[0]}),last:ls(function(U,G){return[G-1]}),eq:ls(function(U,G,Q){return[Q<0?Q+G:Q]}),even:ls(function(U,G){for(var Q=0;Q<G;Q+=2)U.push(Q);return U}),odd:ls(function(U,G){for(var Q=1;Q<G;Q+=2)U.push(Q);return U}),lt:ls(function(U,G,Q){var re;for(Q<0?re=Q+G:Q>G?re=G:re=Q;--re>=0;)U.push(re);return U}),gt:ls(function(U,G,Q){for(var re=Q<0?Q+G:Q;++re<G;)U.push(re);return U})}},c.pseudos.nth=c.pseudos.eq;for(o in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})c.pseudos[o]=Wx(o);for(o in{submit:!0,reset:!0})c.pseudos[o]=Xx(o);function Tp(){}Tp.prototype=c.filters=c.pseudos,c.setFilters=new Tp;function Qo(U,G){var Q,re,de,Te,Ie,qe,Ue,xt=Rt[U+" "];if(xt)return G?0:xt.slice(0);for(Ie=U,qe=[],Ue=c.preFilter;Ie;){(!Q||(re=tn.exec(Ie)))&&(re&&(Ie=Ie.slice(re[0].length)||Ie),qe.push(de=[])),Q=!1,(re=Ko.exec(Ie))&&(Q=re.shift(),de.push({value:Q,type:re[0].replace(ee," ")}),Ie=Ie.slice(Q.length));for(Te in c.filter)(re=ki[Te].exec(Ie))&&(!Ue[Te]||(re=Ue[Te](re)))&&(Q=re.shift(),de.push({value:Q,type:Te,matches:re}),Ie=Ie.slice(Q.length));if(!Q)break}return G?Ie.length:Ie?Bt.error(U):Rt(U,qe).slice(0)}function cl(U){for(var G=0,Q=U.length,re="";G<Q;G++)re+=U[G].value;return re}function ul(U,G,Q){var re=G.dir,de=G.next,Te=de||re,Ie=Q&&Te==="parentNode",qe=Se++;return G.first?function(Ue,xt,rt){for(;Ue=Ue[re];)if(Ue.nodeType===1||Ie)return U(Ue,xt,rt);return!1}:function(Ue,xt,rt){var ut,yt,tt=[te,qe];if(rt){for(;Ue=Ue[re];)if((Ue.nodeType===1||Ie)&&U(Ue,xt,rt))return!0}else for(;Ue=Ue[re];)if(Ue.nodeType===1||Ie)if(yt=Ue[pe]||(Ue[pe]={}),de&&D(Ue,de))Ue=Ue[re]||Ue;else{if((ut=yt[Te])&&ut[0]===te&&ut[1]===qe)return tt[2]=ut[2];if(yt[Te]=tt,tt[2]=U(Ue,xt,rt))return!0}return!1}}function Eu(U){return U.length>1?function(G,Q,re){for(var de=U.length;de--;)if(!U[de](G,Q,re))return!1;return!0}:U[0]}function qx(U,G,Q){for(var re=0,de=G.length;re<de;re++)Bt(U,G[re],Q);return Q}function fl(U,G,Q,re,de){for(var Te,Ie=[],qe=0,Ue=U.length,xt=G!=null;qe<Ue;qe++)(Te=U[qe])&&(!Q||Q(Te,re,de))&&(Ie.push(Te),xt&&G.push(qe));return Ie}function Mu(U,G,Q,re,de,Te){return re&&!re[pe]&&(re=Mu(re)),de&&!de[pe]&&(de=Mu(de,Te)),yi(function(Ie,qe,Ue,xt){var rt,ut,yt,tt,Wt=[],jn=[],bn=qe.length,ci=Ie||qx(G||"*",Ue.nodeType?[Ue]:Ue,[]),Oi=U&&(Ie||!G)?fl(ci,Wt,U,Ue,xt):ci;if(Q?(tt=de||(Ie?U:bn||re)?[]:qe,Q(Oi,tt,Ue,xt)):tt=Oi,re)for(rt=fl(tt,jn),re(rt,[],Ue,xt),ut=rt.length;ut--;)(yt=rt[ut])&&(tt[jn[ut]]=!(Oi[jn[ut]]=yt));if(Ie){if(de||U){if(de){for(rt=[],ut=tt.length;ut--;)(yt=tt[ut])&&rt.push(Oi[ut]=yt);de(null,tt=[],rt,xt)}for(ut=tt.length;ut--;)(yt=tt[ut])&&(rt=de?u.call(Ie,yt):Wt[ut])>-1&&(Ie[rt]=!(qe[rt]=yt))}}else tt=fl(tt===qe?tt.splice(bn,tt.length):tt),de?de(null,qe,tt,xt):T.apply(qe,tt)})}function wu(U){for(var G,Q,re,de=U.length,Te=c.relative[U[0].type],Ie=Te||c.relative[" "],qe=Te?1:0,Ue=ul(function(ut){return ut===G},Ie,!0),xt=ul(function(ut){return u.call(G,ut)>-1},Ie,!0),rt=[function(ut,yt,tt){var Wt=!Te&&(tt||yt!=p)||((G=yt).nodeType?Ue(ut,yt,tt):xt(ut,yt,tt));return G=null,Wt}];qe<de;qe++)if(Q=c.relative[U[qe].type])rt=[ul(Eu(rt),Q)];else{if(Q=c.filter[U[qe].type].apply(null,U[qe].matches),Q[pe]){for(re=++qe;re<de&&!c.relative[U[re].type];re++);return Mu(qe>1&&Eu(rt),qe>1&&cl(U.slice(0,qe-1).concat({value:U[qe-2].type===" "?"*":""})).replace(ee,"$1"),Q,qe<re&&wu(U.slice(qe,re)),re<de&&wu(U=U.slice(re)),re<de&&cl(U))}rt.push(Q)}return Eu(rt)}function $x(U,G){var Q=G.length>0,re=U.length>0,de=function(Te,Ie,qe,Ue,xt){var rt,ut,yt,tt=0,Wt="0",jn=Te&&[],bn=[],ci=p,Oi=Te||re&&c.find.TAG("*",xt),js=te+=ci==null?1:Math.random()||.1,In=Oi.length;for(xt&&(p=Ie==R||Ie||xt);Wt!==In&&(rt=Oi[Wt])!=null;Wt++){if(re&&rt){for(ut=0,!Ie&&rt.ownerDocument!=R&&(Cr(rt),qe=!z);yt=U[ut++];)if(yt(rt,Ie||R,qe)){T.call(Ue,rt);break}xt&&(te=js)}Q&&((rt=!yt&&rt)&&tt--,Te&&jn.push(rt))}if(tt+=Wt,Q&&Wt!==tt){for(ut=0;yt=G[ut++];)yt(jn,bn,Ie,qe);if(Te){if(tt>0)for(;Wt--;)jn[Wt]||bn[Wt]||(bn[Wt]=N.call(Ue));bn=fl(bn)}T.apply(Ue,bn),xt&&!Te&&bn.length>0&&tt+G.length>1&&f.uniqueSort(Ue)}return xt&&(te=js,p=ci),jn};return Q?yi(de):de}function Tu(U,G){var Q,re=[],de=[],Te=pt[U+" "];if(!Te){for(G||(G=Qo(U)),Q=G.length;Q--;)Te=wu(G[Q]),Te[pe]?re.push(Te):de.push(Te);Te=pt(U,$x(de,re)),Te.selector=U}return Te}function bp(U,G,Q,re){var de,Te,Ie,qe,Ue,xt=typeof U=="function"&&U,rt=!re&&Qo(U=xt.selector||U);if(Q=Q||[],rt.length===1){if(Te=rt[0]=rt[0].slice(0),Te.length>2&&(Ie=Te[0]).type==="ID"&&G.nodeType===9&&z&&c.relative[Te[1].type]){if(G=(c.find.ID(Ie.matches[0].replace(Ki,Zi),G)||[])[0],G)xt&&(G=G.parentNode);else return Q;U=U.slice(Te.shift().value.length)}for(de=ki.needsContext.test(U)?0:Te.length;de--&&(Ie=Te[de],!c.relative[qe=Ie.type]);)if((Ue=c.find[qe])&&(re=Ue(Ie.matches[0].replace(Ki,Zi),yu.test(Te[0].type)&&Su(G.parentNode)||G))){if(Te.splice(de,1),U=re.length&&cl(Te),!U)return T.apply(Q,re),Q;break}}return(xt||Tu(U,rt))(re,G,!z,Q,!G||yu.test(U)&&Su(G.parentNode)||G),Q}M.sortStable=pe.split("").sort(dn).join("")===pe,Cr(),M.sortDetached=Hs(function(U){return U.compareDocumentPosition(R.createElement("fieldset"))&1}),f.find=Bt,f.expr[":"]=f.expr.pseudos,f.unique=f.uniqueSort,Bt.compile=Tu,Bt.select=bp,Bt.setDocument=Cr,Bt.tokenize=Qo,Bt.escape=f.escapeSelector,Bt.getText=f.text,Bt.isXML=f.isXMLDoc,Bt.selectors=f.expr,Bt.support=f.support,Bt.uniqueSort=f.uniqueSort})();var ce=function(o,c,p){for(var _=[],w=p!==void 0;(o=o[c])&&o.nodeType!==9;)if(o.nodeType===1){if(w&&f(o).is(p))break;_.push(o)}return _},_e=function(o,c){for(var p=[];o;o=o.nextSibling)o.nodeType===1&&o!==c&&p.push(o);return p},be=f.expr.match.needsContext,Ge=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;function st(o,c,p){return A(c)?f.grep(o,function(_,w){return!!c.call(_,w,_)!==p}):c.nodeType?f.grep(o,function(_){return _===c!==p}):typeof c!="string"?f.grep(o,function(_){return u.call(c,_)>-1!==p}):f.filter(c,o,p)}f.filter=function(o,c,p){var _=c[0];return p&&(o=":not("+o+")"),c.length===1&&_.nodeType===1?f.find.matchesSelector(_,o)?[_]:[]:f.find.matches(o,f.grep(c,function(w){return w.nodeType===1}))},f.fn.extend({find:function(o){var c,p,_=this.length,w=this;if(typeof o!="string")return this.pushStack(f(o).filter(function(){for(c=0;c<_;c++)if(f.contains(w[c],this))return!0}));for(p=this.pushStack([]),c=0;c<_;c++)f.find(o,w[c],p);return _>1?f.uniqueSort(p):p},filter:function(o){return this.pushStack(st(this,o||[],!1))},not:function(o){return this.pushStack(st(this,o||[],!0))},is:function(o){return!!st(this,typeof o=="string"&&be.test(o)?f(o):o||[],!1).length}});var oe,xe=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,Ae=f.fn.init=function(o,c,p){var _,w;if(!o)return this;if(p=p||oe,typeof o=="string")if(o[0]==="<"&&o[o.length-1]===">"&&o.length>=3?_=[null,o,null]:_=xe.exec(o),_&&(_[1]||!c))if(_[1]){if(c=c instanceof f?c[0]:c,f.merge(this,f.parseHTML(_[1],c&&c.nodeType?c.ownerDocument||c:h,!0)),Ge.test(_[1])&&f.isPlainObject(c))for(_ in c)A(this[_])?this[_](c[_]):this.attr(_,c[_]);return this}else return w=h.getElementById(_[2]),w&&(this[0]=w,this.length=1),this;else return!c||c.jquery?(c||p).find(o):this.constructor(c).find(o);else{if(o.nodeType)return this[0]=o,this.length=1,this;if(A(o))return p.ready!==void 0?p.ready(o):o(f)}return f.makeArray(o,this)};Ae.prototype=f.fn,oe=f(h);var ye=/^(?:parents|prev(?:Until|All))/,Fe={children:!0,contents:!0,next:!0,prev:!0};f.fn.extend({has:function(o){var c=f(o,this),p=c.length;return this.filter(function(){for(var _=0;_<p;_++)if(f.contains(this,c[_]))return!0})},closest:function(o,c){var p,_=0,w=this.length,T=[],R=typeof o!="string"&&f(o);if(!be.test(o)){for(;_<w;_++)for(p=this[_];p&&p!==c;p=p.parentNode)if(p.nodeType<11&&(R?R.index(p)>-1:p.nodeType===1&&f.find.matchesSelector(p,o))){T.push(p);break}}return this.pushStack(T.length>1?f.uniqueSort(T):T)},index:function(o){return o?typeof o=="string"?u.call(f(o),this[0]):u.call(this,o.jquery?o[0]:o):this[0]&&this[0].parentNode?this.first().prevAll().length:-1},add:function(o,c){return this.pushStack(f.uniqueSort(f.merge(this.get(),f(o,c))))},addBack:function(o){return this.add(o==null?this.prevObject:this.prevObject.filter(o))}});function nt(o,c){for(;(o=o[c])&&o.nodeType!==1;);return o}f.each({parent:function(o){var c=o.parentNode;return c&&c.nodeType!==11?c:null},parents:function(o){return ce(o,"parentNode")},parentsUntil:function(o,c,p){return ce(o,"parentNode",p)},next:function(o){return nt(o,"nextSibling")},prev:function(o){return nt(o,"previousSibling")},nextAll:function(o){return ce(o,"nextSibling")},prevAll:function(o){return ce(o,"previousSibling")},nextUntil:function(o,c,p){return ce(o,"nextSibling",p)},prevUntil:function(o,c,p){return ce(o,"previousSibling",p)},siblings:function(o){return _e((o.parentNode||{}).firstChild,o)},children:function(o){return _e(o.firstChild)},contents:function(o){return o.contentDocument!=null&&r(o.contentDocument)?o.contentDocument:(D(o,"template")&&(o=o.content||o),f.merge([],o.childNodes))}},function(o,c){f.fn[o]=function(p,_){var w=f.map(this,c,p);return o.slice(-5)!=="Until"&&(_=p),_&&typeof _=="string"&&(w=f.filter(_,w)),this.length>1&&(Fe[o]||f.uniqueSort(w),ye.test(o)&&w.reverse()),this.pushStack(w)}});var He=/[^\x20\t\r\n\f]+/g;function Lt(o){var c={};return f.each(o.match(He)||[],function(p,_){c[_]=!0}),c}f.Callbacks=function(o){o=typeof o=="string"?Lt(o):f.extend({},o);var c,p,_,w,T=[],R=[],j=-1,z=function(){for(w=w||o.once,_=c=!0;R.length;j=-1)for(p=R.shift();++j<T.length;)T[j].apply(p[0],p[1])===!1&&o.stopOnFalse&&(j=T.length,p=!1);o.memory||(p=!1),c=!1,w&&(p?T=[]:T="")},X={add:function(){return T&&(p&&!c&&(j=T.length-1,R.push(p)),function ae(pe){f.each(pe,function(te,Se){A(Se)?(!o.unique||!X.has(Se))&&T.push(Se):Se&&Se.length&&C(Se)!=="string"&&ae(Se)})}(arguments),p&&!c&&z()),this},remove:function(){return f.each(arguments,function(ae,pe){for(var te;(te=f.inArray(pe,T,te))>-1;)T.splice(te,1),te<=j&&j--}),this},has:function(ae){return ae?f.inArray(ae,T)>-1:T.length>0},empty:function(){return T&&(T=[]),this},disable:function(){return w=R=[],T=p="",this},disabled:function(){return!T},lock:function(){return w=R=[],!p&&!c&&(T=p=""),this},locked:function(){return!!w},fireWith:function(ae,pe){return w||(pe=pe||[],pe=[ae,pe.slice?pe.slice():pe],R.push(pe),c||z()),this},fire:function(){return X.fireWith(this,arguments),this},fired:function(){return!!_}};return X};function ht(o){return o}function We(o){throw o}function H(o,c,p,_){var w;try{o&&A(w=o.promise)?w.call(o).done(c).fail(p):o&&A(w=o.then)?w.call(o,c,p):c.apply(void 0,[o].slice(_))}catch(T){p.apply(void 0,[T])}}f.extend({Deferred:function(o){var c=[["notify","progress",f.Callbacks("memory"),f.Callbacks("memory"),2],["resolve","done",f.Callbacks("once memory"),f.Callbacks("once memory"),0,"resolved"],["reject","fail",f.Callbacks("once memory"),f.Callbacks("once memory"),1,"rejected"]],p="pending",_={state:function(){return p},always:function(){return w.done(arguments).fail(arguments),this},catch:function(T){return _.then(null,T)},pipe:function(){var T=arguments;return f.Deferred(function(R){f.each(c,function(j,z){var X=A(T[z[4]])&&T[z[4]];w[z[1]](function(){var ae=X&&X.apply(this,arguments);ae&&A(ae.promise)?ae.promise().progress(R.notify).done(R.resolve).fail(R.reject):R[z[0]+"With"](this,X?[ae]:arguments)})}),T=null}).promise()},then:function(T,R,j){var z=0;function X(ae,pe,te,Se){return function(){var lt=this,Rt=arguments,pt=function(){var dn,Ii;if(!(ae<z)){if(dn=te.apply(lt,Rt),dn===pe.promise())throw new TypeError("Thenable self-resolution");Ii=dn&&(typeof dn=="object"||typeof dn=="function")&&dn.then,A(Ii)?Se?Ii.call(dn,X(z,pe,ht,Se),X(z,pe,We,Se)):(z++,Ii.call(dn,X(z,pe,ht,Se),X(z,pe,We,Se),X(z,pe,ht,pe.notifyWith))):(te!==ht&&(lt=void 0,Rt=[dn]),(Se||pe.resolveWith)(lt,Rt))}},En=Se?pt:function(){try{pt()}catch(dn){f.Deferred.exceptionHook&&f.Deferred.exceptionHook(dn,En.error),ae+1>=z&&(te!==We&&(lt=void 0,Rt=[dn]),pe.rejectWith(lt,Rt))}};ae?En():(f.Deferred.getErrorHook?En.error=f.Deferred.getErrorHook():f.Deferred.getStackHook&&(En.error=f.Deferred.getStackHook()),e.setTimeout(En))}}return f.Deferred(function(ae){c[0][3].add(X(0,ae,A(j)?j:ht,ae.notifyWith)),c[1][3].add(X(0,ae,A(T)?T:ht)),c[2][3].add(X(0,ae,A(R)?R:We))}).promise()},promise:function(T){return T!=null?f.extend(T,_):_}},w={};return f.each(c,function(T,R){var j=R[2],z=R[5];_[R[1]]=j.add,z&&j.add(function(){p=z},c[3-T][2].disable,c[3-T][3].disable,c[0][2].lock,c[0][3].lock),j.add(R[3].fire),w[R[0]]=function(){return w[R[0]+"With"](this===w?void 0:this,arguments),this},w[R[0]+"With"]=j.fireWith}),_.promise(w),o&&o.call(w,w),w},when:function(o){var c=arguments.length,p=c,_=Array(p),w=s.call(arguments),T=f.Deferred(),R=function(j){return function(z){_[j]=this,w[j]=arguments.length>1?s.call(arguments):z,--c||T.resolveWith(_,w)}};if(c<=1&&(H(o,T.done(R(p)).resolve,T.reject,!c),T.state()==="pending"||A(w[p]&&w[p].then)))return T.then();for(;p--;)H(w[p],R(p),T.reject);return T.promise()}});var kt=/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;f.Deferred.exceptionHook=function(o,c){e.console&&e.console.warn&&o&&kt.test(o.name)&&e.console.warn("jQuery.Deferred exception: "+o.message,o.stack,c)},f.readyException=function(o){e.setTimeout(function(){throw o})};var at=f.Deferred();f.fn.ready=function(o){return at.then(o).catch(function(c){f.readyException(c)}),this},f.extend({isReady:!1,readyWait:1,ready:function(o){(o===!0?--f.readyWait:f.isReady)||(f.isReady=!0,!(o!==!0&&--f.readyWait>0)&&at.resolveWith(h,[f]))}}),f.ready.then=at.then;function ft(){h.removeEventListener("DOMContentLoaded",ft),e.removeEventListener("load",ft),f.ready()}h.readyState==="complete"||h.readyState!=="loading"&&!h.documentElement.doScroll?e.setTimeout(f.ready):(h.addEventListener("DOMContentLoaded",ft),e.addEventListener("load",ft));var Xe=function(o,c,p,_,w,T,R){var j=0,z=o.length,X=p==null;if(C(p)==="object"){w=!0;for(j in p)Xe(o,c,j,p[j],!0,T,R)}else if(_!==void 0&&(w=!0,A(_)||(R=!0),X&&(R?(c.call(o,_),c=null):(X=c,c=function(ae,pe,te){return X.call(f(ae),te)})),c))for(;j<z;j++)c(o[j],p,R?_:_.call(o[j],j,c(o[j],p)));return w?o:X?c.call(o):z?c(o[0],p):T},Vt=/^-ms-/,Ke=/-([a-z])/g;function F(o,c){return c.toUpperCase()}function P(o){return o.replace(Vt,"ms-").replace(Ke,F)}var J=function(o){return o.nodeType===1||o.nodeType===9||!+o.nodeType};function ge(){this.expando=f.expando+ge.uid++}ge.uid=1,ge.prototype={cache:function(o){var c=o[this.expando];return c||(c={},J(o)&&(o.nodeType?o[this.expando]=c:Object.defineProperty(o,this.expando,{value:c,configurable:!0}))),c},set:function(o,c,p){var _,w=this.cache(o);if(typeof c=="string")w[P(c)]=p;else for(_ in c)w[P(_)]=c[_];return w},get:function(o,c){return c===void 0?this.cache(o):o[this.expando]&&o[this.expando][P(c)]},access:function(o,c,p){return c===void 0||c&&typeof c=="string"&&p===void 0?this.get(o,c):(this.set(o,c,p),p!==void 0?p:c)},remove:function(o,c){var p,_=o[this.expando];if(_!==void 0){if(c!==void 0)for(Array.isArray(c)?c=c.map(P):(c=P(c),c=c in _?[c]:c.match(He)||[]),p=c.length;p--;)delete _[c[p]];(c===void 0||f.isEmptyObject(_))&&(o.nodeType?o[this.expando]=void 0:delete o[this.expando])}},hasData:function(o){var c=o[this.expando];return c!==void 0&&!f.isEmptyObject(c)}};var Z=new ge,ue=new ge,$e=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Ne=/[A-Z]/g;function je(o){return o==="true"?!0:o==="false"?!1:o==="null"?null:o===+o+""?+o:$e.test(o)?JSON.parse(o):o}function Et(o,c,p){var _;if(p===void 0&&o.nodeType===1)if(_="data-"+c.replace(Ne,"-$&").toLowerCase(),p=o.getAttribute(_),typeof p=="string"){try{p=je(p)}catch{}ue.set(o,c,p)}else p=void 0;return p}f.extend({hasData:function(o){return ue.hasData(o)||Z.hasData(o)},data:function(o,c,p){return ue.access(o,c,p)},removeData:function(o,c){ue.remove(o,c)},_data:function(o,c,p){return Z.access(o,c,p)},_removeData:function(o,c){Z.remove(o,c)}}),f.fn.extend({data:function(o,c){var p,_,w,T=this[0],R=T&&T.attributes;if(o===void 0){if(this.length&&(w=ue.get(T),T.nodeType===1&&!Z.get(T,"hasDataAttrs"))){for(p=R.length;p--;)R[p]&&(_=R[p].name,_.indexOf("data-")===0&&(_=P(_.slice(5)),Et(T,_,w[_])));Z.set(T,"hasDataAttrs",!0)}return w}return typeof o=="object"?this.each(function(){ue.set(this,o)}):Xe(this,function(j){var z;if(T&&j===void 0)return z=ue.get(T,o),z!==void 0||(z=Et(T,o),z!==void 0)?z:void 0;this.each(function(){ue.set(this,o,j)})},null,c,arguments.length>1,null,!0)},removeData:function(o){return this.each(function(){ue.remove(this,o)})}}),f.extend({queue:function(o,c,p){var _;if(o)return c=(c||"fx")+"queue",_=Z.get(o,c),p&&(!_||Array.isArray(p)?_=Z.access(o,c,f.makeArray(p)):_.push(p)),_||[]},dequeue:function(o,c){c=c||"fx";var p=f.queue(o,c),_=p.length,w=p.shift(),T=f._queueHooks(o,c),R=function(){f.dequeue(o,c)};w==="inprogress"&&(w=p.shift(),_--),w&&(c==="fx"&&p.unshift("inprogress"),delete T.stop,w.call(o,R,T)),!_&&T&&T.empty.fire()},_queueHooks:function(o,c){var p=c+"queueHooks";return Z.get(o,p)||Z.access(o,p,{empty:f.Callbacks("once memory").add(function(){Z.remove(o,[c+"queue",p])})})}}),f.fn.extend({queue:function(o,c){var p=2;return typeof o!="string"&&(c=o,o="fx",p--),arguments.length<p?f.queue(this[0],o):c===void 0?this:this.each(function(){var _=f.queue(this,o,c);f._queueHooks(this,o),o==="fx"&&_[0]!=="inprogress"&&f.dequeue(this,o)})},dequeue:function(o){return this.each(function(){f.dequeue(this,o)})},clearQueue:function(o){return this.queue(o||"fx",[])},promise:function(o,c){var p,_=1,w=f.Deferred(),T=this,R=this.length,j=function(){--_||w.resolveWith(T,[T])};for(typeof o!="string"&&(c=o,o=void 0),o=o||"fx";R--;)p=Z.get(T[R],o+"queueHooks"),p&&p.empty&&(_++,p.empty.add(j));return j(),w.promise(c)}});var we=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Oe=new RegExp("^(?:([+-])=|)("+we+")([a-z%]*)$","i"),Ye=["Top","Right","Bottom","Left"],et=h.documentElement,ke=function(o){return f.contains(o.ownerDocument,o)},Mt={composed:!0};et.getRootNode&&(ke=function(o){return f.contains(o.ownerDocument,o)||o.getRootNode(Mt)===o.ownerDocument});var ct=function(o,c){return o=c||o,o.style.display==="none"||o.style.display===""&&ke(o)&&f.css(o,"display")==="none"};function Ot(o,c,p,_){var w,T,R=20,j=_?function(){return _.cur()}:function(){return f.css(o,c,"")},z=j(),X=p&&p[3]||(f.cssNumber[c]?"":"px"),ae=o.nodeType&&(f.cssNumber[c]||X!=="px"&&+z)&&Oe.exec(f.css(o,c));if(ae&&ae[3]!==X){for(z=z/2,X=X||ae[3],ae=+z||1;R--;)f.style(o,c,ae+X),(1-T)*(1-(T=j()/z||.5))<=0&&(R=0),ae=ae/T;ae=ae*2,f.style(o,c,ae+X),p=p||[]}return p&&(ae=+ae||+z||0,w=p[1]?ae+(p[1]+1)*p[2]:+p[2],_&&(_.unit=X,_.start=ae,_.end=w)),w}var $={};function De(o){var c,p=o.ownerDocument,_=o.nodeName,w=$[_];return w||(c=p.body.appendChild(p.createElement(_)),w=f.css(c,"display"),c.parentNode.removeChild(c),w==="none"&&(w="block"),$[_]=w,w)}function le(o,c){for(var p,_,w=[],T=0,R=o.length;T<R;T++)_=o[T],_.style&&(p=_.style.display,c?(p==="none"&&(w[T]=Z.get(_,"display")||null,w[T]||(_.style.display="")),_.style.display===""&&ct(_)&&(w[T]=De(_))):p!=="none"&&(w[T]="none",Z.set(_,"display",p)));for(T=0;T<R;T++)w[T]!=null&&(o[T].style.display=w[T]);return o}f.fn.extend({show:function(){return le(this,!0)},hide:function(){return le(this)},toggle:function(o){return typeof o=="boolean"?o?this.show():this.hide():this.each(function(){ct(this)?f(this).show():f(this).hide()})}});var ve=/^(?:checkbox|radio)$/i,Le=/<([a-z][^\/\0>\x20\t\r\n\f]*)/i,Pe=/^$|^module$|\/(?:java|ecma)script/i;(function(){var o=h.createDocumentFragment(),c=o.appendChild(h.createElement("div")),p=h.createElement("input");p.setAttribute("type","radio"),p.setAttribute("checked","checked"),p.setAttribute("name","t"),c.appendChild(p),M.checkClone=c.cloneNode(!0).cloneNode(!0).lastChild.checked,c.innerHTML="<textarea>x</textarea>",M.noCloneChecked=!!c.cloneNode(!0).lastChild.defaultValue,c.innerHTML="<option></option>",M.option=!!c.lastChild})();var Je={thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};Je.tbody=Je.tfoot=Je.colgroup=Je.caption=Je.thead,Je.th=Je.td,M.option||(Je.optgroup=Je.option=[1,"<select multiple='multiple'>","</select>"]);function vt(o,c){var p;return typeof o.getElementsByTagName<"u"?p=o.getElementsByTagName(c||"*"):typeof o.querySelectorAll<"u"?p=o.querySelectorAll(c||"*"):p=[],c===void 0||c&&D(o,c)?f.merge([o],p):p}function an(o,c){for(var p=0,_=o.length;p<_;p++)Z.set(o[p],"globalEval",!c||Z.get(c[p],"globalEval"))}var Ft=/<|&#?\w+;/;function zn(o,c,p,_,w){for(var T,R,j,z,X,ae,pe=c.createDocumentFragment(),te=[],Se=0,lt=o.length;Se<lt;Se++)if(T=o[Se],T||T===0)if(C(T)==="object")f.merge(te,T.nodeType?[T]:T);else if(!Ft.test(T))te.push(c.createTextNode(T));else{for(R=R||pe.appendChild(c.createElement("div")),j=(Le.exec(T)||["",""])[1].toLowerCase(),z=Je[j]||Je._default,R.innerHTML=z[1]+f.htmlPrefilter(T)+z[2],ae=z[0];ae--;)R=R.lastChild;f.merge(te,R.childNodes),R=pe.firstChild,R.textContent=""}for(pe.textContent="",Se=0;T=te[Se++];){if(_&&f.inArray(T,_)>-1){w&&w.push(T);continue}if(X=ke(T),R=vt(pe.appendChild(T),"script"),X&&an(R),p)for(ae=0;T=R[ae++];)Pe.test(T.type||"")&&p.push(T)}return pe}var ai=/^([^.]*)(?:\.(.+)|)/;function Xi(){return!0}function qi(){return!1}function xi(o,c,p,_,w,T){var R,j;if(typeof c=="object"){typeof p!="string"&&(_=_||p,p=void 0);for(j in c)xi(o,j,p,_,c[j],T);return o}if(_==null&&w==null?(w=p,_=p=void 0):w==null&&(typeof p=="string"?(w=_,_=void 0):(w=_,_=p,p=void 0)),w===!1)w=qi;else if(!w)return o;return T===1&&(R=w,w=function(z){return f().off(z),R.apply(this,arguments)},w.guid=R.guid||(R.guid=f.guid++)),o.each(function(){f.event.add(this,c,w,_,p)})}f.event={global:{},add:function(o,c,p,_,w){var T,R,j,z,X,ae,pe,te,Se,lt,Rt,pt=Z.get(o);if(J(o))for(p.handler&&(T=p,p=T.handler,w=T.selector),w&&f.find.matchesSelector(et,w),p.guid||(p.guid=f.guid++),(z=pt.events)||(z=pt.events=Object.create(null)),(R=pt.handle)||(R=pt.handle=function(En){return typeof f<"u"&&f.event.triggered!==En.type?f.event.dispatch.apply(o,arguments):void 0}),c=(c||"").match(He)||[""],X=c.length;X--;)j=ai.exec(c[X])||[],Se=Rt=j[1],lt=(j[2]||"").split(".").sort(),Se&&(pe=f.event.special[Se]||{},Se=(w?pe.delegateType:pe.bindType)||Se,pe=f.event.special[Se]||{},ae=f.extend({type:Se,origType:Rt,data:_,handler:p,guid:p.guid,selector:w,needsContext:w&&f.expr.match.needsContext.test(w),namespace:lt.join(".")},T),(te=z[Se])||(te=z[Se]=[],te.delegateCount=0,(!pe.setup||pe.setup.call(o,_,lt,R)===!1)&&o.addEventListener&&o.addEventListener(Se,R)),pe.add&&(pe.add.call(o,ae),ae.handler.guid||(ae.handler.guid=p.guid)),w?te.splice(te.delegateCount++,0,ae):te.push(ae),f.event.global[Se]=!0)},remove:function(o,c,p,_,w){var T,R,j,z,X,ae,pe,te,Se,lt,Rt,pt=Z.hasData(o)&&Z.get(o);if(!(!pt||!(z=pt.events))){for(c=(c||"").match(He)||[""],X=c.length;X--;){if(j=ai.exec(c[X])||[],Se=Rt=j[1],lt=(j[2]||"").split(".").sort(),!Se){for(Se in z)f.event.remove(o,Se+c[X],p,_,!0);continue}for(pe=f.event.special[Se]||{},Se=(_?pe.delegateType:pe.bindType)||Se,te=z[Se]||[],j=j[2]&&new RegExp("(^|\\.)"+lt.join("\\.(?:.*\\.|)")+"(\\.|$)"),R=T=te.length;T--;)ae=te[T],(w||Rt===ae.origType)&&(!p||p.guid===ae.guid)&&(!j||j.test(ae.namespace))&&(!_||_===ae.selector||_==="**"&&ae.selector)&&(te.splice(T,1),ae.selector&&te.delegateCount--,pe.remove&&pe.remove.call(o,ae));R&&!te.length&&((!pe.teardown||pe.teardown.call(o,lt,pt.handle)===!1)&&f.removeEvent(o,Se,pt.handle),delete z[Se])}f.isEmptyObject(z)&&Z.remove(o,"handle events")}},dispatch:function(o){var c,p,_,w,T,R,j=new Array(arguments.length),z=f.event.fix(o),X=(Z.get(this,"events")||Object.create(null))[z.type]||[],ae=f.event.special[z.type]||{};for(j[0]=z,c=1;c<arguments.length;c++)j[c]=arguments[c];if(z.delegateTarget=this,!(ae.preDispatch&&ae.preDispatch.call(this,z)===!1)){for(R=f.event.handlers.call(this,z,X),c=0;(w=R[c++])&&!z.isPropagationStopped();)for(z.currentTarget=w.elem,p=0;(T=w.handlers[p++])&&!z.isImmediatePropagationStopped();)(!z.rnamespace||T.namespace===!1||z.rnamespace.test(T.namespace))&&(z.handleObj=T,z.data=T.data,_=((f.event.special[T.origType]||{}).handle||T.handler).apply(w.elem,j),_!==void 0&&(z.result=_)===!1&&(z.preventDefault(),z.stopPropagation()));return ae.postDispatch&&ae.postDispatch.call(this,z),z.result}},handlers:function(o,c){var p,_,w,T,R,j=[],z=c.delegateCount,X=o.target;if(z&&X.nodeType&&!(o.type==="click"&&o.button>=1)){for(;X!==this;X=X.parentNode||this)if(X.nodeType===1&&!(o.type==="click"&&X.disabled===!0)){for(T=[],R={},p=0;p<z;p++)_=c[p],w=_.selector+" ",R[w]===void 0&&(R[w]=_.needsContext?f(w,this).index(X)>-1:f.find(w,this,null,[X]).length),R[w]&&T.push(_);T.length&&j.push({elem:X,handlers:T})}}return X=this,z<c.length&&j.push({elem:X,handlers:c.slice(z)}),j},addProp:function(o,c){Object.defineProperty(f.Event.prototype,o,{enumerable:!0,configurable:!0,get:A(c)?function(){if(this.originalEvent)return c(this.originalEvent)}:function(){if(this.originalEvent)return this.originalEvent[o]},set:function(p){Object.defineProperty(this,o,{enumerable:!0,configurable:!0,writable:!0,value:p})}})},fix:function(o){return o[f.expando]?o:new f.Event(o)},special:{load:{noBubble:!0},click:{setup:function(o){var c=this||o;return ve.test(c.type)&&c.click&&D(c,"input")&&Mr(c,"click",!0),!1},trigger:function(o){var c=this||o;return ve.test(c.type)&&c.click&&D(c,"input")&&Mr(c,"click"),!0},_default:function(o){var c=o.target;return ve.test(c.type)&&c.click&&D(c,"input")&&Z.get(c,"click")||D(c,"a")}},beforeunload:{postDispatch:function(o){o.result!==void 0&&o.originalEvent&&(o.originalEvent.returnValue=o.result)}}}};function Mr(o,c,p){if(!p){Z.get(o,c)===void 0&&f.event.add(o,c,Xi);return}Z.set(o,c,!1),f.event.add(o,c,{namespace:!1,handler:function(_){var w,T=Z.get(this,c);if(_.isTrigger&1&&this[c]){if(T)(f.event.special[c]||{}).delegateType&&_.stopPropagation();else if(T=s.call(arguments),Z.set(this,c,T),this[c](),w=Z.get(this,c),Z.set(this,c,!1),T!==w)return _.stopImmediatePropagation(),_.preventDefault(),w}else T&&(Z.set(this,c,f.event.trigger(T[0],T.slice(1),this)),_.stopPropagation(),_.isImmediatePropagationStopped=Xi)}})}f.removeEvent=function(o,c,p){o.removeEventListener&&o.removeEventListener(c,p)},f.Event=function(o,c){if(!(this instanceof f.Event))return new f.Event(o,c);o&&o.type?(this.originalEvent=o,this.type=o.type,this.isDefaultPrevented=o.defaultPrevented||o.defaultPrevented===void 0&&o.returnValue===!1?Xi:qi,this.target=o.target&&o.target.nodeType===3?o.target.parentNode:o.target,this.currentTarget=o.currentTarget,this.relatedTarget=o.relatedTarget):this.type=o,c&&f.extend(this,c),this.timeStamp=o&&o.timeStamp||Date.now(),this[f.expando]=!0},f.Event.prototype={constructor:f.Event,isDefaultPrevented:qi,isPropagationStopped:qi,isImmediatePropagationStopped:qi,isSimulated:!1,preventDefault:function(){var o=this.originalEvent;this.isDefaultPrevented=Xi,o&&!this.isSimulated&&o.preventDefault()},stopPropagation:function(){var o=this.originalEvent;this.isPropagationStopped=Xi,o&&!this.isSimulated&&o.stopPropagation()},stopImmediatePropagation:function(){var o=this.originalEvent;this.isImmediatePropagationStopped=Xi,o&&!this.isSimulated&&o.stopImmediatePropagation(),this.stopPropagation()}},f.each({altKey:!0,bubbles:!0,cancelable:!0,changedTouches:!0,ctrlKey:!0,detail:!0,eventPhase:!0,metaKey:!0,pageX:!0,pageY:!0,shiftKey:!0,view:!0,char:!0,code:!0,charCode:!0,key:!0,keyCode:!0,button:!0,buttons:!0,clientX:!0,clientY:!0,offsetX:!0,offsetY:!0,pointerId:!0,pointerType:!0,screenX:!0,screenY:!0,targetTouches:!0,toElement:!0,touches:!0,which:!0},f.event.addProp),f.each({focus:"focusin",blur:"focusout"},function(o,c){function p(_){if(h.documentMode){var w=Z.get(this,"handle"),T=f.event.fix(_);T.type=_.type==="focusin"?"focus":"blur",T.isSimulated=!0,w(_),T.target===T.currentTarget&&w(T)}else f.event.simulate(c,_.target,f.event.fix(_))}f.event.special[o]={setup:function(){var _;if(Mr(this,o,!0),h.documentMode)_=Z.get(this,c),_||this.addEventListener(c,p),Z.set(this,c,(_||0)+1);else return!1},trigger:function(){return Mr(this,o),!0},teardown:function(){var _;if(h.documentMode)_=Z.get(this,c)-1,_?Z.set(this,c,_):(this.removeEventListener(c,p),Z.remove(this,c));else return!1},_default:function(_){return Z.get(_.target,o)},delegateType:c},f.event.special[c]={setup:function(){var _=this.ownerDocument||this.document||this,w=h.documentMode?this:_,T=Z.get(w,c);T||(h.documentMode?this.addEventListener(c,p):_.addEventListener(o,p,!0)),Z.set(w,c,(T||0)+1)},teardown:function(){var _=this.ownerDocument||this.document||this,w=h.documentMode?this:_,T=Z.get(w,c)-1;T?Z.set(w,c,T):(h.documentMode?this.removeEventListener(c,p):_.removeEventListener(o,p,!0),Z.remove(w,c))}}}),f.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(o,c){f.event.special[o]={delegateType:c,bindType:c,handle:function(p){var _,w=this,T=p.relatedTarget,R=p.handleObj;return(!T||T!==w&&!f.contains(w,T))&&(p.type=R.origType,_=R.handler.apply(this,arguments),p.type=c),_}}}),f.fn.extend({on:function(o,c,p,_){return xi(this,o,c,p,_)},one:function(o,c,p,_){return xi(this,o,c,p,_,1)},off:function(o,c,p){var _,w;if(o&&o.preventDefault&&o.handleObj)return _=o.handleObj,f(o.delegateTarget).off(_.namespace?_.origType+"."+_.namespace:_.origType,_.selector,_.handler),this;if(typeof o=="object"){for(w in o)this.off(w,c,o[w]);return this}return(c===!1||typeof c=="function")&&(p=c,c=void 0),p===!1&&(p=qi),this.each(function(){f.event.remove(this,o,p,c)})}});var rl=/<script|<style|<link/i,sl=/checked\s*(?:[^=]|=\s*.checked.)/i,Os=/^\s*<!\[CDATA\[|\]\]>\s*$/g;function Vo(o,c){return D(o,"table")&&D(c.nodeType!==11?c:c.firstChild,"tr")&&f(o).children("tbody")[0]||o}function Bs(o){return o.type=(o.getAttribute("type")!==null)+"/"+o.type,o}function ol(o){return(o.type||"").slice(0,5)==="true/"?o.type=o.type.slice(5):o.removeAttribute("type"),o}function Go(o,c){var p,_,w,T,R,j,z;if(c.nodeType===1){if(Z.hasData(o)&&(T=Z.get(o),z=T.events,z)){Z.remove(c,"handle events");for(w in z)for(p=0,_=z[w].length;p<_;p++)f.event.add(c,w,z[w][p])}ue.hasData(o)&&(R=ue.access(o),j=f.extend({},R),ue.set(c,j))}}function fu(o,c){var p=c.nodeName.toLowerCase();p==="input"&&ve.test(o.type)?c.checked=o.checked:(p==="input"||p==="textarea")&&(c.defaultValue=o.defaultValue)}function wr(o,c,p,_){c=a(c);var w,T,R,j,z,X,ae=0,pe=o.length,te=pe-1,Se=c[0],lt=A(Se);if(lt||pe>1&&typeof Se=="string"&&!M.checkClone&&sl.test(Se))return o.each(function(Rt){var pt=o.eq(Rt);lt&&(c[0]=Se.call(this,Rt,pt.html())),wr(pt,c,p,_)});if(pe&&(w=zn(c,o[0].ownerDocument,!1,o,_),T=w.firstChild,w.childNodes.length===1&&(w=T),T||_)){for(R=f.map(vt(w,"script"),Bs),j=R.length;ae<pe;ae++)z=w,ae!==te&&(z=f.clone(z,!0,!0),j&&f.merge(R,vt(z,"script"))),p.call(o[ae],z,ae);if(j)for(X=R[R.length-1].ownerDocument,f.map(R,ol),ae=0;ae<j;ae++)z=R[ae],Pe.test(z.type||"")&&!Z.access(z,"globalEval")&&f.contains(X,z)&&(z.src&&(z.type||"").toLowerCase()!=="module"?f._evalUrl&&!z.noModule&&f._evalUrl(z.src,{nonce:z.nonce||z.getAttribute("nonce")},X):b(z.textContent.replace(Os,""),z,X))}return o}function al(o,c,p){for(var _,w=c?f.filter(c,o):o,T=0;(_=w[T])!=null;T++)!p&&_.nodeType===1&&f.cleanData(vt(_)),_.parentNode&&(p&&ke(_)&&an(vt(_,"script")),_.parentNode.removeChild(_));return o}f.extend({htmlPrefilter:function(o){return o},clone:function(o,c,p){var _,w,T,R,j=o.cloneNode(!0),z=ke(o);if(!M.noCloneChecked&&(o.nodeType===1||o.nodeType===11)&&!f.isXMLDoc(o))for(R=vt(j),T=vt(o),_=0,w=T.length;_<w;_++)fu(T[_],R[_]);if(c)if(p)for(T=T||vt(o),R=R||vt(j),_=0,w=T.length;_<w;_++)Go(T[_],R[_]);else Go(o,j);return R=vt(j,"script"),R.length>0&&an(R,!z&&vt(o,"script")),j},cleanData:function(o){for(var c,p,_,w=f.event.special,T=0;(p=o[T])!==void 0;T++)if(J(p)){if(c=p[Z.expando]){if(c.events)for(_ in c.events)w[_]?f.event.remove(p,_):f.removeEvent(p,_,c.handle);p[Z.expando]=void 0}p[ue.expando]&&(p[ue.expando]=void 0)}}}),f.fn.extend({detach:function(o){return al(this,o,!0)},remove:function(o){return al(this,o)},text:function(o){return Xe(this,function(c){return c===void 0?f.text(this):this.empty().each(function(){(this.nodeType===1||this.nodeType===11||this.nodeType===9)&&(this.textContent=c)})},null,o,arguments.length)},append:function(){return wr(this,arguments,function(o){if(this.nodeType===1||this.nodeType===11||this.nodeType===9){var c=Vo(this,o);c.appendChild(o)}})},prepend:function(){return wr(this,arguments,function(o){if(this.nodeType===1||this.nodeType===11||this.nodeType===9){var c=Vo(this,o);c.insertBefore(o,c.firstChild)}})},before:function(){return wr(this,arguments,function(o){this.parentNode&&this.parentNode.insertBefore(o,this)})},after:function(){return wr(this,arguments,function(o){this.parentNode&&this.parentNode.insertBefore(o,this.nextSibling)})},empty:function(){for(var o,c=0;(o=this[c])!=null;c++)o.nodeType===1&&(f.cleanData(vt(o,!1)),o.textContent="");return this},clone:function(o,c){return o=o??!1,c=c??o,this.map(function(){return f.clone(this,o,c)})},html:function(o){return Xe(this,function(c){var p=this[0]||{},_=0,w=this.length;if(c===void 0&&p.nodeType===1)return p.innerHTML;if(typeof c=="string"&&!rl.test(c)&&!Je[(Le.exec(c)||["",""])[1].toLowerCase()]){c=f.htmlPrefilter(c);try{for(;_<w;_++)p=this[_]||{},p.nodeType===1&&(f.cleanData(vt(p,!1)),p.innerHTML=c);p=0}catch{}}p&&this.empty().append(c)},null,o,arguments.length)},replaceWith:function(){var o=[];return wr(this,arguments,function(c){var p=this.parentNode;f.inArray(this,o)<0&&(f.cleanData(vt(this)),p&&p.replaceChild(c,this))},o)}}),f.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(o,c){f.fn[o]=function(p){for(var _,w=[],T=f(p),R=T.length-1,j=0;j<=R;j++)_=j===R?this:this.clone(!0),f(T[j])[c](_),l.apply(w,_.get());return this.pushStack(w)}});var Wo=new RegExp("^("+we+")(?!px)[a-z%]+$","i"),Xo=/^--/,zs=function(o){var c=o.ownerDocument.defaultView;return(!c||!c.opener)&&(c=e),c.getComputedStyle(o)},L=function(o,c,p){var _,w,T={};for(w in c)T[w]=o.style[w],o.style[w]=c[w];_=p.call(o);for(w in c)o.style[w]=T[w];return _},Y=new RegExp(Ye.join("|"),"i");(function(){function o(){if(X){z.style.cssText="position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",X.style.cssText="position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%",et.appendChild(z).appendChild(X);var ae=e.getComputedStyle(X);p=ae.top!=="1%",j=c(ae.marginLeft)===12,X.style.right="60%",T=c(ae.right)===36,_=c(ae.width)===36,X.style.position="absolute",w=c(X.offsetWidth/3)===12,et.removeChild(z),X=null}}function c(ae){return Math.round(parseFloat(ae))}var p,_,w,T,R,j,z=h.createElement("div"),X=h.createElement("div");X.style&&(X.style.backgroundClip="content-box",X.cloneNode(!0).style.backgroundClip="",M.clearCloneStyle=X.style.backgroundClip==="content-box",f.extend(M,{boxSizingReliable:function(){return o(),_},pixelBoxStyles:function(){return o(),T},pixelPosition:function(){return o(),p},reliableMarginLeft:function(){return o(),j},scrollboxSize:function(){return o(),w},reliableTrDimensions:function(){var ae,pe,te,Se;return R==null&&(ae=h.createElement("table"),pe=h.createElement("tr"),te=h.createElement("div"),ae.style.cssText="position:absolute;left:-11111px;border-collapse:separate",pe.style.cssText="box-sizing:content-box;border:1px solid",pe.style.height="1px",te.style.height="9px",te.style.display="block",et.appendChild(ae).appendChild(pe).appendChild(te),Se=e.getComputedStyle(pe),R=parseInt(Se.height,10)+parseInt(Se.borderTopWidth,10)+parseInt(Se.borderBottomWidth,10)===pe.offsetHeight,et.removeChild(ae)),R}}))})();function ne(o,c,p){var _,w,T,R,j=Xo.test(c),z=o.style;return p=p||zs(o),p&&(R=p.getPropertyValue(c)||p[c],j&&R&&(R=R.replace(ee,"$1")||void 0),R===""&&!ke(o)&&(R=f.style(o,c)),!M.pixelBoxStyles()&&Wo.test(R)&&Y.test(c)&&(_=z.width,w=z.minWidth,T=z.maxWidth,z.minWidth=z.maxWidth=z.width=R,R=p.width,z.width=_,z.minWidth=w,z.maxWidth=T)),R!==void 0?R+"":R}function ie(o,c){return{get:function(){if(o()){delete this.get;return}return(this.get=c).apply(this,arguments)}}}var K=["Webkit","Moz","ms"],Ee=h.createElement("div").style,Ce={};function Be(o){for(var c=o[0].toUpperCase()+o.slice(1),p=K.length;p--;)if(o=K[p]+c,o in Ee)return o}function ze(o){var c=f.cssProps[o]||Ce[o];return c||(o in Ee?o:Ce[o]=Be(o)||o)}var ot=/^(none|table(?!-c[ea]).+)/,it={position:"absolute",visibility:"hidden",display:"block"},Qe={letterSpacing:"0",fontWeight:"400"};function wt(o,c,p){var _=Oe.exec(c);return _?Math.max(0,_[2]-(p||0))+(_[3]||"px"):c}function Ct(o,c,p,_,w,T){var R=c==="width"?1:0,j=0,z=0,X=0;if(p===(_?"border":"content"))return 0;for(;R<4;R+=2)p==="margin"&&(X+=f.css(o,p+Ye[R],!0,w)),_?(p==="content"&&(z-=f.css(o,"padding"+Ye[R],!0,w)),p!=="margin"&&(z-=f.css(o,"border"+Ye[R]+"Width",!0,w))):(z+=f.css(o,"padding"+Ye[R],!0,w),p!=="padding"?z+=f.css(o,"border"+Ye[R]+"Width",!0,w):j+=f.css(o,"border"+Ye[R]+"Width",!0,w));return!_&&T>=0&&(z+=Math.max(0,Math.ceil(o["offset"+c[0].toUpperCase()+c.slice(1)]-T-z-j-.5))||0),z+X}function Zt(o,c,p){var _=zs(o),w=!M.boxSizingReliable()||p,T=w&&f.css(o,"boxSizing",!1,_)==="border-box",R=T,j=ne(o,c,_),z="offset"+c[0].toUpperCase()+c.slice(1);if(Wo.test(j)){if(!p)return j;j="auto"}return(!M.boxSizingReliable()&&T||!M.reliableTrDimensions()&&D(o,"tr")||j==="auto"||!parseFloat(j)&&f.css(o,"display",!1,_)==="inline")&&o.getClientRects().length&&(T=f.css(o,"boxSizing",!1,_)==="border-box",R=z in o,R&&(j=o[z])),j=parseFloat(j)||0,j+Ct(o,c,p||(T?"border":"content"),R,_,j)+"px"}f.extend({cssHooks:{opacity:{get:function(o,c){if(c){var p=ne(o,"opacity");return p===""?"1":p}}}},cssNumber:{animationIterationCount:!0,aspectRatio:!0,borderImageSlice:!0,columnCount:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,gridArea:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnStart:!0,gridRow:!0,gridRowEnd:!0,gridRowStart:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,scale:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeMiterlimit:!0,strokeOpacity:!0},cssProps:{},style:function(o,c,p,_){if(!(!o||o.nodeType===3||o.nodeType===8||!o.style)){var w,T,R,j=P(c),z=Xo.test(c),X=o.style;if(z||(c=ze(j)),R=f.cssHooks[c]||f.cssHooks[j],p!==void 0){if(T=typeof p,T==="string"&&(w=Oe.exec(p))&&w[1]&&(p=Ot(o,c,w),T="number"),p==null||p!==p)return;T==="number"&&!z&&(p+=w&&w[3]||(f.cssNumber[j]?"":"px")),!M.clearCloneStyle&&p===""&&c.indexOf("background")===0&&(X[c]="inherit"),(!R||!("set"in R)||(p=R.set(o,p,_))!==void 0)&&(z?X.setProperty(c,p):X[c]=p)}else return R&&"get"in R&&(w=R.get(o,!1,_))!==void 0?w:X[c]}},css:function(o,c,p,_){var w,T,R,j=P(c),z=Xo.test(c);return z||(c=ze(j)),R=f.cssHooks[c]||f.cssHooks[j],R&&"get"in R&&(w=R.get(o,!0,p)),w===void 0&&(w=ne(o,c,_)),w==="normal"&&c in Qe&&(w=Qe[c]),p===""||p?(T=parseFloat(w),p===!0||isFinite(T)?T||0:w):w}}),f.each(["height","width"],function(o,c){f.cssHooks[c]={get:function(p,_,w){if(_)return ot.test(f.css(p,"display"))&&(!p.getClientRects().length||!p.getBoundingClientRect().width)?L(p,it,function(){return Zt(p,c,w)}):Zt(p,c,w)},set:function(p,_,w){var T,R=zs(p),j=!M.scrollboxSize()&&R.position==="absolute",z=j||w,X=z&&f.css(p,"boxSizing",!1,R)==="border-box",ae=w?Ct(p,c,w,X,R):0;return X&&j&&(ae-=Math.ceil(p["offset"+c[0].toUpperCase()+c.slice(1)]-parseFloat(R[c])-Ct(p,c,"border",!1,R)-.5)),ae&&(T=Oe.exec(_))&&(T[3]||"px")!=="px"&&(p.style[c]=_,_=f.css(p,c)),wt(p,_,ae)}}}),f.cssHooks.marginLeft=ie(M.reliableMarginLeft,function(o,c){if(c)return(parseFloat(ne(o,"marginLeft"))||o.getBoundingClientRect().left-L(o,{marginLeft:0},function(){return o.getBoundingClientRect().left}))+"px"}),f.each({margin:"",padding:"",border:"Width"},function(o,c){f.cssHooks[o+c]={expand:function(p){for(var _=0,w={},T=typeof p=="string"?p.split(" "):[p];_<4;_++)w[o+Ye[_]+c]=T[_]||T[_-2]||T[0];return w}},o!=="margin"&&(f.cssHooks[o+c].set=wt)}),f.fn.extend({css:function(o,c){return Xe(this,function(p,_,w){var T,R,j={},z=0;if(Array.isArray(_)){for(T=zs(p),R=_.length;z<R;z++)j[_[z]]=f.css(p,_[z],!1,T);return j}return w!==void 0?f.style(p,_,w):f.css(p,_)},o,c,arguments.length>1)}});function _t(o,c,p,_,w){return new _t.prototype.init(o,c,p,_,w)}f.Tween=_t,_t.prototype={constructor:_t,init:function(o,c,p,_,w,T){this.elem=o,this.prop=p,this.easing=w||f.easing._default,this.options=c,this.start=this.now=this.cur(),this.end=_,this.unit=T||(f.cssNumber[p]?"":"px")},cur:function(){var o=_t.propHooks[this.prop];return o&&o.get?o.get(this):_t.propHooks._default.get(this)},run:function(o){var c,p=_t.propHooks[this.prop];return this.options.duration?this.pos=c=f.easing[this.easing](o,this.options.duration*o,0,1,this.options.duration):this.pos=c=o,this.now=(this.end-this.start)*c+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),p&&p.set?p.set(this):_t.propHooks._default.set(this),this}},_t.prototype.init.prototype=_t.prototype,_t.propHooks={_default:{get:function(o){var c;return o.elem.nodeType!==1||o.elem[o.prop]!=null&&o.elem.style[o.prop]==null?o.elem[o.prop]:(c=f.css(o.elem,o.prop,""),!c||c==="auto"?0:c)},set:function(o){f.fx.step[o.prop]?f.fx.step[o.prop](o):o.elem.nodeType===1&&(f.cssHooks[o.prop]||o.elem.style[ze(o.prop)]!=null)?f.style(o.elem,o.prop,o.now+o.unit):o.elem[o.prop]=o.now}}},_t.propHooks.scrollTop=_t.propHooks.scrollLeft={set:function(o){o.elem.nodeType&&o.elem.parentNode&&(o.elem[o.prop]=o.now)}},f.easing={linear:function(o){return o},swing:function(o){return .5-Math.cos(o*Math.PI)/2},_default:"swing"},f.fx=_t.prototype.init,f.fx.step={};var gt,Ze,fn=/^(?:toggle|show|hide)$/,It=/queueHooks$/;function Ln(){Ze&&(h.hidden===!1&&e.requestAnimationFrame?e.requestAnimationFrame(Ln):e.setTimeout(Ln,f.fx.interval),f.fx.tick())}function $i(){return e.setTimeout(function(){gt=void 0}),gt=Date.now()}function vn(o,c){var p,_=0,w={height:o};for(c=c?1:0;_<4;_+=2-c)p=Ye[_],w["margin"+p]=w["padding"+p]=o;return c&&(w.opacity=w.width=o),w}function Tr(o,c,p){for(var _,w=(Yt.tweeners[c]||[]).concat(Yt.tweeners["*"]),T=0,R=w.length;T<R;T++)if(_=w[T].call(p,c,o))return _}function Gt(o,c,p){var _,w,T,R,j,z,X,ae,pe="width"in c||"height"in c,te=this,Se={},lt=o.style,Rt=o.nodeType&&ct(o),pt=Z.get(o,"fxshow");p.queue||(R=f._queueHooks(o,"fx"),R.unqueued==null&&(R.unqueued=0,j=R.empty.fire,R.empty.fire=function(){R.unqueued||j()}),R.unqueued++,te.always(function(){te.always(function(){R.unqueued--,f.queue(o,"fx").length||R.empty.fire()})}));for(_ in c)if(w=c[_],fn.test(w)){if(delete c[_],T=T||w==="toggle",w===(Rt?"hide":"show"))if(w==="show"&&pt&&pt[_]!==void 0)Rt=!0;else continue;Se[_]=pt&&pt[_]||f.style(o,_)}if(z=!f.isEmptyObject(c),!(!z&&f.isEmptyObject(Se))){pe&&o.nodeType===1&&(p.overflow=[lt.overflow,lt.overflowX,lt.overflowY],X=pt&&pt.display,X==null&&(X=Z.get(o,"display")),ae=f.css(o,"display"),ae==="none"&&(X?ae=X:(le([o],!0),X=o.style.display||X,ae=f.css(o,"display"),le([o]))),(ae==="inline"||ae==="inline-block"&&X!=null)&&f.css(o,"float")==="none"&&(z||(te.done(function(){lt.display=X}),X==null&&(ae=lt.display,X=ae==="none"?"":ae)),lt.display="inline-block")),p.overflow&&(lt.overflow="hidden",te.always(function(){lt.overflow=p.overflow[0],lt.overflowX=p.overflow[1],lt.overflowY=p.overflow[2]})),z=!1;for(_ in Se)z||(pt?"hidden"in pt&&(Rt=pt.hidden):pt=Z.access(o,"fxshow",{display:X}),T&&(pt.hidden=!Rt),Rt&&le([o],!0),te.done(function(){Rt||le([o]),Z.remove(o,"fxshow");for(_ in Se)f.style(o,_,Se[_])})),z=Tr(Rt?pt[_]:0,_,te),_ in pt||(pt[_]=z.start,Rt&&(z.end=z.start,z.start=0))}}function Hn(o,c){var p,_,w,T,R;for(p in o)if(_=P(p),w=c[_],T=o[p],Array.isArray(T)&&(w=T[1],T=o[p]=T[0]),p!==_&&(o[_]=T,delete o[p]),R=f.cssHooks[_],R&&"expand"in R){T=R.expand(T),delete o[_];for(p in T)p in o||(o[p]=T[p],c[p]=w)}else c[_]=w}function Yt(o,c,p){var _,w,T=0,R=Yt.prefilters.length,j=f.Deferred().always(function(){delete z.elem}),z=function(){if(w)return!1;for(var pe=gt||$i(),te=Math.max(0,X.startTime+X.duration-pe),Se=te/X.duration||0,lt=1-Se,Rt=0,pt=X.tweens.length;Rt<pt;Rt++)X.tweens[Rt].run(lt);return j.notifyWith(o,[X,lt,te]),lt<1&&pt?te:(pt||j.notifyWith(o,[X,1,0]),j.resolveWith(o,[X]),!1)},X=j.promise({elem:o,props:f.extend({},c),opts:f.extend(!0,{specialEasing:{},easing:f.easing._default},p),originalProperties:c,originalOptions:p,startTime:gt||$i(),duration:p.duration,tweens:[],createTween:function(pe,te){var Se=f.Tween(o,X.opts,pe,te,X.opts.specialEasing[pe]||X.opts.easing);return X.tweens.push(Se),Se},stop:function(pe){var te=0,Se=pe?X.tweens.length:0;if(w)return this;for(w=!0;te<Se;te++)X.tweens[te].run(1);return pe?(j.notifyWith(o,[X,1,0]),j.resolveWith(o,[X,pe])):j.rejectWith(o,[X,pe]),this}}),ae=X.props;for(Hn(ae,X.opts.specialEasing);T<R;T++)if(_=Yt.prefilters[T].call(X,o,ae,X.opts),_)return A(_.stop)&&(f._queueHooks(X.elem,X.opts.queue).stop=_.stop.bind(_)),_;return f.map(ae,Tr,X),A(X.opts.start)&&X.opts.start.call(o,X),X.progress(X.opts.progress).done(X.opts.done,X.opts.complete).fail(X.opts.fail).always(X.opts.always),f.fx.timer(f.extend(z,{elem:o,anim:X,queue:X.opts.queue})),X}f.Animation=f.extend(Yt,{tweeners:{"*":[function(o,c){var p=this.createTween(o,c);return Ot(p.elem,o,Oe.exec(c),p),p}]},tweener:function(o,c){A(o)?(c=o,o=["*"]):o=o.match(He);for(var p,_=0,w=o.length;_<w;_++)p=o[_],Yt.tweeners[p]=Yt.tweeners[p]||[],Yt.tweeners[p].unshift(c)},prefilters:[Gt],prefilter:function(o,c){c?Yt.prefilters.unshift(o):Yt.prefilters.push(o)}}),f.speed=function(o,c,p){var _=o&&typeof o=="object"?f.extend({},o):{complete:p||!p&&c||A(o)&&o,duration:o,easing:p&&c||c&&!A(c)&&c};return f.fx.off?_.duration=0:typeof _.duration!="number"&&(_.duration in f.fx.speeds?_.duration=f.fx.speeds[_.duration]:_.duration=f.fx.speeds._default),(_.queue==null||_.queue===!0)&&(_.queue="fx"),_.old=_.complete,_.complete=function(){A(_.old)&&_.old.call(this),_.queue&&f.dequeue(this,_.queue)},_},f.fn.extend({fadeTo:function(o,c,p,_){return this.filter(ct).css("opacity",0).show().end().animate({opacity:c},o,p,_)},animate:function(o,c,p,_){var w=f.isEmptyObject(o),T=f.speed(c,p,_),R=function(){var j=Yt(this,f.extend({},o),T);(w||Z.get(this,"finish"))&&j.stop(!0)};return R.finish=R,w||T.queue===!1?this.each(R):this.queue(T.queue,R)},stop:function(o,c,p){var _=function(w){var T=w.stop;delete w.stop,T(p)};return typeof o!="string"&&(p=c,c=o,o=void 0),c&&this.queue(o||"fx",[]),this.each(function(){var w=!0,T=o!=null&&o+"queueHooks",R=f.timers,j=Z.get(this);if(T)j[T]&&j[T].stop&&_(j[T]);else for(T in j)j[T]&&j[T].stop&&It.test(T)&&_(j[T]);for(T=R.length;T--;)R[T].elem===this&&(o==null||R[T].queue===o)&&(R[T].anim.stop(p),w=!1,R.splice(T,1));(w||!p)&&f.dequeue(this,o)})},finish:function(o){return o!==!1&&(o=o||"fx"),this.each(function(){var c,p=Z.get(this),_=p[o+"queue"],w=p[o+"queueHooks"],T=f.timers,R=_?_.length:0;for(p.finish=!0,f.queue(this,o,[]),w&&w.stop&&w.stop.call(this,!0),c=T.length;c--;)T[c].elem===this&&T[c].queue===o&&(T[c].anim.stop(!0),T.splice(c,1));for(c=0;c<R;c++)_[c]&&_[c].finish&&_[c].finish.call(this);delete p.finish})}}),f.each(["toggle","show","hide"],function(o,c){var p=f.fn[c];f.fn[c]=function(_,w,T){return _==null||typeof _=="boolean"?p.apply(this,arguments):this.animate(vn(c,!0),_,w,T)}}),f.each({slideDown:vn("show"),slideUp:vn("hide"),slideToggle:vn("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(o,c){f.fn[o]=function(p,_,w){return this.animate(c,p,_,w)}}),f.timers=[],f.fx.tick=function(){var o,c=0,p=f.timers;for(gt=Date.now();c<p.length;c++)o=p[c],!o()&&p[c]===o&&p.splice(c--,1);p.length||f.fx.stop(),gt=void 0},f.fx.timer=function(o){f.timers.push(o),f.fx.start()},f.fx.interval=13,f.fx.start=function(){Ze||(Ze=!0,Ln())},f.fx.stop=function(){Ze=null},f.fx.speeds={slow:600,fast:200,_default:400},f.fn.delay=function(o,c){return o=f.fx&&f.fx.speeds[o]||o,c=c||"fx",this.queue(c,function(p,_){var w=e.setTimeout(p,o);_.stop=function(){e.clearTimeout(w)}})},function(){var o=h.createElement("input"),c=h.createElement("select"),p=c.appendChild(h.createElement("option"));o.type="checkbox",M.checkOn=o.value!=="",M.optSelected=p.selected,o=h.createElement("input"),o.value="t",o.type="radio",M.radioValue=o.value==="t"}();var _n,ln=f.expr.attrHandle;f.fn.extend({attr:function(o,c){return Xe(this,f.attr,o,c,arguments.length>1)},removeAttr:function(o){return this.each(function(){f.removeAttr(this,o)})}}),f.extend({attr:function(o,c,p){var _,w,T=o.nodeType;if(!(T===3||T===8||T===2)){if(typeof o.getAttribute>"u")return f.prop(o,c,p);if((T!==1||!f.isXMLDoc(o))&&(w=f.attrHooks[c.toLowerCase()]||(f.expr.match.bool.test(c)?_n:void 0)),p!==void 0){if(p===null){f.removeAttr(o,c);return}return w&&"set"in w&&(_=w.set(o,p,c))!==void 0?_:(o.setAttribute(c,p+""),p)}return w&&"get"in w&&(_=w.get(o,c))!==null?_:(_=f.find.attr(o,c),_??void 0)}},attrHooks:{type:{set:function(o,c){if(!M.radioValue&&c==="radio"&&D(o,"input")){var p=o.value;return o.setAttribute("type",c),p&&(o.value=p),c}}}},removeAttr:function(o,c){var p,_=0,w=c&&c.match(He);if(w&&o.nodeType===1)for(;p=w[_++];)o.removeAttribute(p)}}),_n={set:function(o,c,p){return c===!1?f.removeAttr(o,p):o.setAttribute(p,p),p}},f.each(f.expr.match.bool.source.match(/\w+/g),function(o,c){var p=ln[c]||f.find.attr;ln[c]=function(_,w,T){var R,j,z=w.toLowerCase();return T||(j=ln[z],ln[z]=R,R=p(_,w,T)!=null?z:null,ln[z]=j),R}});var qo=/^(?:input|select|textarea|button)$/i,Yi=/^(?:a|area)$/i;f.fn.extend({prop:function(o,c){return Xe(this,f.prop,o,c,arguments.length>1)},removeProp:function(o){return this.each(function(){delete this[f.propFix[o]||o]})}}),f.extend({prop:function(o,c,p){var _,w,T=o.nodeType;if(!(T===3||T===8||T===2))return(T!==1||!f.isXMLDoc(o))&&(c=f.propFix[c]||c,w=f.propHooks[c]),p!==void 0?w&&"set"in w&&(_=w.set(o,p,c))!==void 0?_:o[c]=p:w&&"get"in w&&(_=w.get(o,c))!==null?_:o[c]},propHooks:{tabIndex:{get:function(o){var c=f.find.attr(o,"tabindex");return c?parseInt(c,10):qo.test(o.nodeName)||Yi.test(o.nodeName)&&o.href?0:-1}}},propFix:{for:"htmlFor",class:"className"}}),M.optSelected||(f.propHooks.selected={get:function(o){var c=o.parentNode;return c&&c.parentNode&&c.parentNode.selectedIndex,null},set:function(o){var c=o.parentNode;c&&(c.selectedIndex,c.parentNode&&c.parentNode.selectedIndex)}}),f.each(["tabIndex","readOnly","maxLength","cellSpacing","cellPadding","rowSpan","colSpan","useMap","frameBorder","contentEditable"],function(){f.propFix[this.toLowerCase()]=this});function ss(o){var c=o.match(He)||[];return c.join(" ")}function os(o){return o.getAttribute&&o.getAttribute("class")||""}function du(o){return Array.isArray(o)?o:typeof o=="string"?o.match(He)||[]:[]}f.fn.extend({addClass:function(o){var c,p,_,w,T,R;return A(o)?this.each(function(j){f(this).addClass(o.call(this,j,os(this)))}):(c=du(o),c.length?this.each(function(){if(_=os(this),p=this.nodeType===1&&" "+ss(_)+" ",p){for(T=0;T<c.length;T++)w=c[T],p.indexOf(" "+w+" ")<0&&(p+=w+" ");R=ss(p),_!==R&&this.setAttribute("class",R)}}):this)},removeClass:function(o){var c,p,_,w,T,R;return A(o)?this.each(function(j){f(this).removeClass(o.call(this,j,os(this)))}):arguments.length?(c=du(o),c.length?this.each(function(){if(_=os(this),p=this.nodeType===1&&" "+ss(_)+" ",p){for(T=0;T<c.length;T++)for(w=c[T];p.indexOf(" "+w+" ")>-1;)p=p.replace(" "+w+" "," ");R=ss(p),_!==R&&this.setAttribute("class",R)}}):this):this.attr("class","")},toggleClass:function(o,c){var p,_,w,T,R=typeof o,j=R==="string"||Array.isArray(o);return A(o)?this.each(function(z){f(this).toggleClass(o.call(this,z,os(this),c),c)}):typeof c=="boolean"&&j?c?this.addClass(o):this.removeClass(o):(p=du(o),this.each(function(){if(j)for(T=f(this),w=0;w<p.length;w++)_=p[w],T.hasClass(_)?T.removeClass(_):T.addClass(_);else(o===void 0||R==="boolean")&&(_=os(this),_&&Z.set(this,"__className__",_),this.setAttribute&&this.setAttribute("class",_||o===!1?"":Z.get(this,"__className__")||""))}))},hasClass:function(o){var c,p,_=0;for(c=" "+o+" ";p=this[_++];)if(p.nodeType===1&&(" "+ss(os(p))+" ").indexOf(c)>-1)return!0;return!1}});var Tx=/\r/g;f.fn.extend({val:function(o){var c,p,_,w=this[0];return arguments.length?(_=A(o),this.each(function(T){var R;this.nodeType===1&&(_?R=o.call(this,T,f(this).val()):R=o,R==null?R="":typeof R=="number"?R+="":Array.isArray(R)&&(R=f.map(R,function(j){return j==null?"":j+""})),c=f.valHooks[this.type]||f.valHooks[this.nodeName.toLowerCase()],(!c||!("set"in c)||c.set(this,R,"value")===void 0)&&(this.value=R))})):w?(c=f.valHooks[w.type]||f.valHooks[w.nodeName.toLowerCase()],c&&"get"in c&&(p=c.get(w,"value"))!==void 0?p:(p=w.value,typeof p=="string"?p.replace(Tx,""):p??"")):void 0}}),f.extend({valHooks:{option:{get:function(o){var c=f.find.attr(o,"value");return c??ss(f.text(o))}},select:{get:function(o){var c,p,_,w=o.options,T=o.selectedIndex,R=o.type==="select-one",j=R?null:[],z=R?T+1:w.length;for(T<0?_=z:_=R?T:0;_<z;_++)if(p=w[_],(p.selected||_===T)&&!p.disabled&&(!p.parentNode.disabled||!D(p.parentNode,"optgroup"))){if(c=f(p).val(),R)return c;j.push(c)}return j},set:function(o,c){for(var p,_,w=o.options,T=f.makeArray(c),R=w.length;R--;)_=w[R],(_.selected=f.inArray(f.valHooks.option.get(_),T)>-1)&&(p=!0);return p||(o.selectedIndex=-1),T}}}}),f.each(["radio","checkbox"],function(){f.valHooks[this]={set:function(o,c){if(Array.isArray(c))return o.checked=f.inArray(f(o).val(),c)>-1}},M.checkOn||(f.valHooks[this].get=function(o){return o.getAttribute("value")===null?"on":o.value})});var $o=e.location,mp={guid:Date.now()},hu=/\?/;f.parseXML=function(o){var c,p;if(!o||typeof o!="string")return null;try{c=new e.DOMParser().parseFromString(o,"text/xml")}catch{}return p=c&&c.getElementsByTagName("parsererror")[0],(!c||p)&&f.error("Invalid XML: "+(p?f.map(p.childNodes,function(_){return _.textContent}).join(`
`):o)),c};var gp=/^(?:focusinfocus|focusoutblur)$/,vp=function(o){o.stopPropagation()};f.extend(f.event,{trigger:function(o,c,p,_){var w,T,R,j,z,X,ae,pe,te=[p||h],Se=g.call(o,"type")?o.type:o,lt=g.call(o,"namespace")?o.namespace.split("."):[];if(T=pe=R=p=p||h,!(p.nodeType===3||p.nodeType===8)&&!gp.test(Se+f.event.triggered)&&(Se.indexOf(".")>-1&&(lt=Se.split("."),Se=lt.shift(),lt.sort()),z=Se.indexOf(":")<0&&"on"+Se,o=o[f.expando]?o:new f.Event(Se,typeof o=="object"&&o),o.isTrigger=_?2:3,o.namespace=lt.join("."),o.rnamespace=o.namespace?new RegExp("(^|\\.)"+lt.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,o.result=void 0,o.target||(o.target=p),c=c==null?[o]:f.makeArray(c,[o]),ae=f.event.special[Se]||{},!(!_&&ae.trigger&&ae.trigger.apply(p,c)===!1))){if(!_&&!ae.noBubble&&!E(p)){for(j=ae.delegateType||Se,gp.test(j+Se)||(T=T.parentNode);T;T=T.parentNode)te.push(T),R=T;R===(p.ownerDocument||h)&&te.push(R.defaultView||R.parentWindow||e)}for(w=0;(T=te[w++])&&!o.isPropagationStopped();)pe=T,o.type=w>1?j:ae.bindType||Se,X=(Z.get(T,"events")||Object.create(null))[o.type]&&Z.get(T,"handle"),X&&X.apply(T,c),X=z&&T[z],X&&X.apply&&J(T)&&(o.result=X.apply(T,c),o.result===!1&&o.preventDefault());return o.type=Se,!_&&!o.isDefaultPrevented()&&(!ae._default||ae._default.apply(te.pop(),c)===!1)&&J(p)&&z&&A(p[Se])&&!E(p)&&(R=p[z],R&&(p[z]=null),f.event.triggered=Se,o.isPropagationStopped()&&pe.addEventListener(Se,vp),p[Se](),o.isPropagationStopped()&&pe.removeEventListener(Se,vp),f.event.triggered=void 0,R&&(p[z]=R)),o.result}},simulate:function(o,c,p){var _=f.extend(new f.Event,p,{type:o,isSimulated:!0});f.event.trigger(_,null,c)}}),f.fn.extend({trigger:function(o,c){return this.each(function(){f.event.trigger(o,c,this)})},triggerHandler:function(o,c){var p=this[0];if(p)return f.event.trigger(o,c,p,!0)}});var bx=/\[\]$/,_p=/\r?\n/g,Ax=/^(?:submit|button|image|reset|file)$/i,Cx=/^(?:input|select|textarea|keygen)/i;function pu(o,c,p,_){var w;if(Array.isArray(c))f.each(c,function(T,R){p||bx.test(o)?_(o,R):pu(o+"["+(typeof R=="object"&&R!=null?T:"")+"]",R,p,_)});else if(!p&&C(c)==="object")for(w in c)pu(o+"["+w+"]",c[w],p,_);else _(o,c)}f.param=function(o,c){var p,_=[],w=function(T,R){var j=A(R)?R():R;_[_.length]=encodeURIComponent(T)+"="+encodeURIComponent(j??"")};if(o==null)return"";if(Array.isArray(o)||o.jquery&&!f.isPlainObject(o))f.each(o,function(){w(this.name,this.value)});else for(p in o)pu(p,o[p],c,w);return _.join("&")},f.fn.extend({serialize:function(){return f.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var o=f.prop(this,"elements");return o?f.makeArray(o):this}).filter(function(){var o=this.type;return this.name&&!f(this).is(":disabled")&&Cx.test(this.nodeName)&&!Ax.test(o)&&(this.checked||!ve.test(o))}).map(function(o,c){var p=f(this).val();return p==null?null:Array.isArray(p)?f.map(p,function(_){return{name:c.name,value:_.replace(_p,`\r
`)}}):{name:c.name,value:p.replace(_p,`\r
`)}}).get()}});var Rx=/%20/g,Px=/#.*$/,Nx=/([?&])_=[^&]*/,Dx=/^(.*?):[ \t]*([^\r\n]*)$/mg,Lx=/^(?:about|app|app-storage|.+-extension|file|res|widget):$/,Ix=/^(?:GET|HEAD)$/,Ux=/^\/\//,xp={},mu={},yp="*/".concat("*"),gu=h.createElement("a");gu.href=$o.href;function Sp(o){return function(c,p){typeof c!="string"&&(p=c,c="*");var _,w=0,T=c.toLowerCase().match(He)||[];if(A(p))for(;_=T[w++];)_[0]==="+"?(_=_.slice(1)||"*",(o[_]=o[_]||[]).unshift(p)):(o[_]=o[_]||[]).push(p)}}function Ep(o,c,p,_){var w={},T=o===mu;function R(j){var z;return w[j]=!0,f.each(o[j]||[],function(X,ae){var pe=ae(c,p,_);if(typeof pe=="string"&&!T&&!w[pe])return c.dataTypes.unshift(pe),R(pe),!1;if(T)return!(z=pe)}),z}return R(c.dataTypes[0])||!w["*"]&&R("*")}function vu(o,c){var p,_,w=f.ajaxSettings.flatOptions||{};for(p in c)c[p]!==void 0&&((w[p]?o:_||(_={}))[p]=c[p]);return _&&f.extend(!0,o,_),o}function Fx(o,c,p){for(var _,w,T,R,j=o.contents,z=o.dataTypes;z[0]==="*";)z.shift(),_===void 0&&(_=o.mimeType||c.getResponseHeader("Content-Type"));if(_){for(w in j)if(j[w]&&j[w].test(_)){z.unshift(w);break}}if(z[0]in p)T=z[0];else{for(w in p){if(!z[0]||o.converters[w+" "+z[0]]){T=w;break}R||(R=w)}T=T||R}if(T)return T!==z[0]&&z.unshift(T),p[T]}function kx(o,c,p,_){var w,T,R,j,z,X={},ae=o.dataTypes.slice();if(ae[1])for(R in o.converters)X[R.toLowerCase()]=o.converters[R];for(T=ae.shift();T;)if(o.responseFields[T]&&(p[o.responseFields[T]]=c),!z&&_&&o.dataFilter&&(c=o.dataFilter(c,o.dataType)),z=T,T=ae.shift(),T){if(T==="*")T=z;else if(z!=="*"&&z!==T){if(R=X[z+" "+T]||X["* "+T],!R){for(w in X)if(j=w.split(" "),j[1]===T&&(R=X[z+" "+j[0]]||X["* "+j[0]],R)){R===!0?R=X[w]:X[w]!==!0&&(T=j[0],ae.unshift(j[1]));break}}if(R!==!0)if(R&&o.throws)c=R(c);else try{c=R(c)}catch(pe){return{state:"parsererror",error:R?pe:"No conversion from "+z+" to "+T}}}}return{state:"success",data:c}}f.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:$o.href,type:"GET",isLocal:Lx.test($o.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":yp,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":JSON.parse,"text xml":f.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(o,c){return c?vu(vu(o,f.ajaxSettings),c):vu(f.ajaxSettings,o)},ajaxPrefilter:Sp(xp),ajaxTransport:Sp(mu),ajax:function(o,c){typeof o=="object"&&(c=o,o=void 0),c=c||{};var p,_,w,T,R,j,z,X,ae,pe,te=f.ajaxSetup({},c),Se=te.context||te,lt=te.context&&(Se.nodeType||Se.jquery)?f(Se):f.event,Rt=f.Deferred(),pt=f.Callbacks("once memory"),En=te.statusCode||{},dn={},Ii={},Ui="canceled",Tt={readyState:0,getResponseHeader:function(Pt){var tn;if(z){if(!T)for(T={};tn=Dx.exec(w);)T[tn[1].toLowerCase()+" "]=(T[tn[1].toLowerCase()+" "]||[]).concat(tn[2]);tn=T[Pt.toLowerCase()+" "]}return tn==null?null:tn.join(", ")},getAllResponseHeaders:function(){return z?w:null},setRequestHeader:function(Pt,tn){return z==null&&(Pt=Ii[Pt.toLowerCase()]=Ii[Pt.toLowerCase()]||Pt,dn[Pt]=tn),this},overrideMimeType:function(Pt){return z==null&&(te.mimeType=Pt),this},statusCode:function(Pt){var tn;if(Pt)if(z)Tt.always(Pt[Tt.status]);else for(tn in Pt)En[tn]=[En[tn],Pt[tn]];return this},abort:function(Pt){var tn=Pt||Ui;return p&&p.abort(tn),as(0,tn),this}};if(Rt.promise(Tt),te.url=((o||te.url||$o.href)+"").replace(Ux,$o.protocol+"//"),te.type=c.method||c.type||te.method||te.type,te.dataTypes=(te.dataType||"*").toLowerCase().match(He)||[""],te.crossDomain==null){j=h.createElement("a");try{j.href=te.url,j.href=j.href,te.crossDomain=gu.protocol+"//"+gu.host!=j.protocol+"//"+j.host}catch{te.crossDomain=!0}}if(te.data&&te.processData&&typeof te.data!="string"&&(te.data=f.param(te.data,te.traditional)),Ep(xp,te,c,Tt),z)return Tt;X=f.event&&te.global,X&&f.active++===0&&f.event.trigger("ajaxStart"),te.type=te.type.toUpperCase(),te.hasContent=!Ix.test(te.type),_=te.url.replace(Px,""),te.hasContent?te.data&&te.processData&&(te.contentType||"").indexOf("application/x-www-form-urlencoded")===0&&(te.data=te.data.replace(Rx,"+")):(pe=te.url.slice(_.length),te.data&&(te.processData||typeof te.data=="string")&&(_+=(hu.test(_)?"&":"?")+te.data,delete te.data),te.cache===!1&&(_=_.replace(Nx,"$1"),pe=(hu.test(_)?"&":"?")+"_="+mp.guid+++pe),te.url=_+pe),te.ifModified&&(f.lastModified[_]&&Tt.setRequestHeader("If-Modified-Since",f.lastModified[_]),f.etag[_]&&Tt.setRequestHeader("If-None-Match",f.etag[_])),(te.data&&te.hasContent&&te.contentType!==!1||c.contentType)&&Tt.setRequestHeader("Content-Type",te.contentType),Tt.setRequestHeader("Accept",te.dataTypes[0]&&te.accepts[te.dataTypes[0]]?te.accepts[te.dataTypes[0]]+(te.dataTypes[0]!=="*"?", "+yp+"; q=0.01":""):te.accepts["*"]);for(ae in te.headers)Tt.setRequestHeader(ae,te.headers[ae]);if(te.beforeSend&&(te.beforeSend.call(Se,Tt,te)===!1||z))return Tt.abort();if(Ui="abort",pt.add(te.complete),Tt.done(te.success),Tt.fail(te.error),p=Ep(mu,te,c,Tt),!p)as(-1,"No Transport");else{if(Tt.readyState=1,X&&lt.trigger("ajaxSend",[Tt,te]),z)return Tt;te.async&&te.timeout>0&&(R=e.setTimeout(function(){Tt.abort("timeout")},te.timeout));try{z=!1,p.send(dn,as)}catch(Pt){if(z)throw Pt;as(-1,Pt)}}function as(Pt,tn,Ko,xu){var Fi,Zo,ki,br,Ar,li=tn;z||(z=!0,R&&e.clearTimeout(R),p=void 0,w=xu||"",Tt.readyState=Pt>0?4:0,Fi=Pt>=200&&Pt<300||Pt===304,Ko&&(br=Fx(te,Tt,Ko)),!Fi&&f.inArray("script",te.dataTypes)>-1&&f.inArray("json",te.dataTypes)<0&&(te.converters["text script"]=function(){}),br=kx(te,br,Tt,Fi),Fi?(te.ifModified&&(Ar=Tt.getResponseHeader("Last-Modified"),Ar&&(f.lastModified[_]=Ar),Ar=Tt.getResponseHeader("etag"),Ar&&(f.etag[_]=Ar)),Pt===204||te.type==="HEAD"?li="nocontent":Pt===304?li="notmodified":(li=br.state,Zo=br.data,ki=br.error,Fi=!ki)):(ki=li,(Pt||!li)&&(li="error",Pt<0&&(Pt=0))),Tt.status=Pt,Tt.statusText=(tn||li)+"",Fi?Rt.resolveWith(Se,[Zo,li,Tt]):Rt.rejectWith(Se,[Tt,li,ki]),Tt.statusCode(En),En=void 0,X&&lt.trigger(Fi?"ajaxSuccess":"ajaxError",[Tt,te,Fi?Zo:ki]),pt.fireWith(Se,[Tt,li]),X&&(lt.trigger("ajaxComplete",[Tt,te]),--f.active||f.event.trigger("ajaxStop")))}return Tt},getJSON:function(o,c,p){return f.get(o,c,p,"json")},getScript:function(o,c){return f.get(o,void 0,c,"script")}}),f.each(["get","post"],function(o,c){f[c]=function(p,_,w,T){return A(_)&&(T=T||w,w=_,_=void 0),f.ajax(f.extend({url:p,type:c,dataType:T,data:_,success:w},f.isPlainObject(p)&&p))}}),f.ajaxPrefilter(function(o){var c;for(c in o.headers)c.toLowerCase()==="content-type"&&(o.contentType=o.headers[c]||"")}),f._evalUrl=function(o,c,p){return f.ajax({url:o,type:"GET",dataType:"script",cache:!0,async:!1,global:!1,converters:{"text script":function(){}},dataFilter:function(_){f.globalEval(_,c,p)}})},f.fn.extend({wrapAll:function(o){var c;return this[0]&&(A(o)&&(o=o.call(this[0])),c=f(o,this[0].ownerDocument).eq(0).clone(!0),this[0].parentNode&&c.insertBefore(this[0]),c.map(function(){for(var p=this;p.firstElementChild;)p=p.firstElementChild;return p}).append(this)),this},wrapInner:function(o){return A(o)?this.each(function(c){f(this).wrapInner(o.call(this,c))}):this.each(function(){var c=f(this),p=c.contents();p.length?p.wrapAll(o):c.append(o)})},wrap:function(o){var c=A(o);return this.each(function(p){f(this).wrapAll(c?o.call(this,p):o)})},unwrap:function(o){return this.parent(o).not("body").each(function(){f(this).replaceWith(this.childNodes)}),this}}),f.expr.pseudos.hidden=function(o){return!f.expr.pseudos.visible(o)},f.expr.pseudos.visible=function(o){return!!(o.offsetWidth||o.offsetHeight||o.getClientRects().length)},f.ajaxSettings.xhr=function(){try{return new e.XMLHttpRequest}catch{}};var Ox={0:200,1223:204},Yo=f.ajaxSettings.xhr();M.cors=!!Yo&&"withCredentials"in Yo,M.ajax=Yo=!!Yo,f.ajaxTransport(function(o){var c,p;if(M.cors||Yo&&!o.crossDomain)return{send:function(_,w){var T,R=o.xhr();if(R.open(o.type,o.url,o.async,o.username,o.password),o.xhrFields)for(T in o.xhrFields)R[T]=o.xhrFields[T];o.mimeType&&R.overrideMimeType&&R.overrideMimeType(o.mimeType),!o.crossDomain&&!_["X-Requested-With"]&&(_["X-Requested-With"]="XMLHttpRequest");for(T in _)R.setRequestHeader(T,_[T]);c=function(j){return function(){c&&(c=p=R.onload=R.onerror=R.onabort=R.ontimeout=R.onreadystatechange=null,j==="abort"?R.abort():j==="error"?typeof R.status!="number"?w(0,"error"):w(R.status,R.statusText):w(Ox[R.status]||R.status,R.statusText,(R.responseType||"text")!=="text"||typeof R.responseText!="string"?{binary:R.response}:{text:R.responseText},R.getAllResponseHeaders()))}},R.onload=c(),p=R.onerror=R.ontimeout=c("error"),R.onabort!==void 0?R.onabort=p:R.onreadystatechange=function(){R.readyState===4&&e.setTimeout(function(){c&&p()})},c=c("abort");try{R.send(o.hasContent&&o.data||null)}catch(j){if(c)throw j}},abort:function(){c&&c()}}}),f.ajaxPrefilter(function(o){o.crossDomain&&(o.contents.script=!1)}),f.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/\b(?:java|ecma)script\b/},converters:{"text script":function(o){return f.globalEval(o),o}}}),f.ajaxPrefilter("script",function(o){o.cache===void 0&&(o.cache=!1),o.crossDomain&&(o.type="GET")}),f.ajaxTransport("script",function(o){if(o.crossDomain||o.scriptAttrs){var c,p;return{send:function(_,w){c=f("<script>").attr(o.scriptAttrs||{}).prop({charset:o.scriptCharset,src:o.url}).on("load error",p=function(T){c.remove(),p=null,T&&w(T.type==="error"?404:200,T.type)}),h.head.appendChild(c[0])},abort:function(){p&&p()}}}});var Mp=[],_u=/(=)\?(?=&|$)|\?\?/;f.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var o=Mp.pop()||f.expando+"_"+mp.guid++;return this[o]=!0,o}}),f.ajaxPrefilter("json jsonp",function(o,c,p){var _,w,T,R=o.jsonp!==!1&&(_u.test(o.url)?"url":typeof o.data=="string"&&(o.contentType||"").indexOf("application/x-www-form-urlencoded")===0&&_u.test(o.data)&&"data");if(R||o.dataTypes[0]==="jsonp")return _=o.jsonpCallback=A(o.jsonpCallback)?o.jsonpCallback():o.jsonpCallback,R?o[R]=o[R].replace(_u,"$1"+_):o.jsonp!==!1&&(o.url+=(hu.test(o.url)?"&":"?")+o.jsonp+"="+_),o.converters["script json"]=function(){return T||f.error(_+" was not called"),T[0]},o.dataTypes[0]="json",w=e[_],e[_]=function(){T=arguments},p.always(function(){w===void 0?f(e).removeProp(_):e[_]=w,o[_]&&(o.jsonpCallback=c.jsonpCallback,Mp.push(_)),T&&A(w)&&w(T[0]),T=w=void 0}),"script"}),M.createHTMLDocument=function(){var o=h.implementation.createHTMLDocument("").body;return o.innerHTML="<form></form><form></form>",o.childNodes.length===2}(),f.parseHTML=function(o,c,p){if(typeof o!="string")return[];typeof c=="boolean"&&(p=c,c=!1);var _,w,T;return c||(M.createHTMLDocument?(c=h.implementation.createHTMLDocument(""),_=c.createElement("base"),_.href=h.location.href,c.head.appendChild(_)):c=h),w=Ge.exec(o),T=!p&&[],w?[c.createElement(w[1])]:(w=zn([o],c,T),T&&T.length&&f(T).remove(),f.merge([],w.childNodes))},f.fn.load=function(o,c,p){var _,w,T,R=this,j=o.indexOf(" ");return j>-1&&(_=ss(o.slice(j)),o=o.slice(0,j)),A(c)?(p=c,c=void 0):c&&typeof c=="object"&&(w="POST"),R.length>0&&f.ajax({url:o,type:w||"GET",dataType:"html",data:c}).done(function(z){T=arguments,R.html(_?f("<div>").append(f.parseHTML(z)).find(_):z)}).always(p&&function(z,X){R.each(function(){p.apply(this,T||[z.responseText,X,z])})}),this},f.expr.pseudos.animated=function(o){return f.grep(f.timers,function(c){return o===c.elem}).length},f.offset={setOffset:function(o,c,p){var _,w,T,R,j,z,X,ae=f.css(o,"position"),pe=f(o),te={};ae==="static"&&(o.style.position="relative"),j=pe.offset(),T=f.css(o,"top"),z=f.css(o,"left"),X=(ae==="absolute"||ae==="fixed")&&(T+z).indexOf("auto")>-1,X?(_=pe.position(),R=_.top,w=_.left):(R=parseFloat(T)||0,w=parseFloat(z)||0),A(c)&&(c=c.call(o,p,f.extend({},j))),c.top!=null&&(te.top=c.top-j.top+R),c.left!=null&&(te.left=c.left-j.left+w),"using"in c?c.using.call(o,te):pe.css(te)}},f.fn.extend({offset:function(o){if(arguments.length)return o===void 0?this:this.each(function(w){f.offset.setOffset(this,o,w)});var c,p,_=this[0];if(_)return _.getClientRects().length?(c=_.getBoundingClientRect(),p=_.ownerDocument.defaultView,{top:c.top+p.pageYOffset,left:c.left+p.pageXOffset}):{top:0,left:0}},position:function(){if(this[0]){var o,c,p,_=this[0],w={top:0,left:0};if(f.css(_,"position")==="fixed")c=_.getBoundingClientRect();else{for(c=this.offset(),p=_.ownerDocument,o=_.offsetParent||p.documentElement;o&&(o===p.body||o===p.documentElement)&&f.css(o,"position")==="static";)o=o.parentNode;o&&o!==_&&o.nodeType===1&&(w=f(o).offset(),w.top+=f.css(o,"borderTopWidth",!0),w.left+=f.css(o,"borderLeftWidth",!0))}return{top:c.top-w.top-f.css(_,"marginTop",!0),left:c.left-w.left-f.css(_,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var o=this.offsetParent;o&&f.css(o,"position")==="static";)o=o.offsetParent;return o||et})}}),f.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(o,c){var p=c==="pageYOffset";f.fn[o]=function(_){return Xe(this,function(w,T,R){var j;if(E(w)?j=w:w.nodeType===9&&(j=w.defaultView),R===void 0)return j?j[c]:w[T];j?j.scrollTo(p?j.pageXOffset:R,p?R:j.pageYOffset):w[T]=R},o,_,arguments.length)}}),f.each(["top","left"],function(o,c){f.cssHooks[c]=ie(M.pixelPosition,function(p,_){if(_)return _=ne(p,c),Wo.test(_)?f(p).position()[c]+"px":_})}),f.each({Height:"height",Width:"width"},function(o,c){f.each({padding:"inner"+o,content:c,"":"outer"+o},function(p,_){f.fn[_]=function(w,T){var R=arguments.length&&(p||typeof w!="boolean"),j=p||(w===!0||T===!0?"margin":"border");return Xe(this,function(z,X,ae){var pe;return E(z)?_.indexOf("outer")===0?z["inner"+o]:z.document.documentElement["client"+o]:z.nodeType===9?(pe=z.documentElement,Math.max(z.body["scroll"+o],pe["scroll"+o],z.body["offset"+o],pe["offset"+o],pe["client"+o])):ae===void 0?f.css(z,X,j):f.style(z,X,ae,j)},c,R?w:void 0,R)}})}),f.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(o,c){f.fn[c]=function(p){return this.on(c,p)}}),f.fn.extend({bind:function(o,c,p){return this.on(o,null,c,p)},unbind:function(o,c){return this.off(o,null,c)},delegate:function(o,c,p,_){return this.on(c,o,p,_)},undelegate:function(o,c,p){return arguments.length===1?this.off(o,"**"):this.off(c,o||"**",p)},hover:function(o,c){return this.on("mouseenter",o).on("mouseleave",c||o)}}),f.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "),function(o,c){f.fn[c]=function(p,_){return arguments.length>0?this.on(c,null,p,_):this.trigger(c)}});var Bx=/^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g;f.proxy=function(o,c){var p,_,w;if(typeof c=="string"&&(p=o[c],c=o,o=p),!!A(o))return _=s.call(arguments,2),w=function(){return o.apply(c||this,_.concat(s.call(arguments)))},w.guid=o.guid=o.guid||f.guid++,w},f.holdReady=function(o){o?f.readyWait++:f.ready(!0)},f.isArray=Array.isArray,f.parseJSON=JSON.parse,f.nodeName=D,f.isFunction=A,f.isWindow=E,f.camelCase=P,f.type=C,f.now=Date.now,f.isNumeric=function(o){var c=f.type(o);return(c==="number"||c==="string")&&!isNaN(o-parseFloat(o))},f.trim=function(o){return o==null?"":(o+"").replace(Bx,"$1")};var zx=e.jQuery,Hx=e.$;return f.noConflict=function(o){return e.$===f&&(e.$=Hx),o&&e.jQuery===f&&(e.jQuery=zx),f},typeof n>"u"&&(e.jQuery=e.$=f),f})}(Qu)),Qu.exports}/*!
 * Lightbox v2.11.5
 * by Lokesh Dhakar
 *
 * More info:
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,transparent:!0,depthWrite:!1,blending:Ed}),A=new oM(u,M);s.add(A),r.current=A;const E=()=>{!n.current||!i.current||(n.current.aspect=window.innerWidth/window.innerHeight,n.current.updateProjectionMatrix(),i.current.setSize(window.innerWidth,window.innerHeight))};window.addEventListener("resize",E);const h=new Ht,S=new Ht,b=I=>{S.x=I.clientX/window.innerWidth*2-1,S.y=-(I.clientY/window.innerHeight)*2+1};window.addEventListener("mousemove",b);let C=0;const k=()=>{if(C=requestAnimationFrame(k),!r.current||!i.current||!e.current||!n.current)return;h.x+=(S.x-h.x)*.05,h.y+=(S.y-h.y)*.05,r.current.rotation.x=h.y*.3,r.current.rotation.y=h.x*.3,r.current.rotation.z+=.001;const I=r.current.geometry.attributes.position.array;for(let f=0;f<I.length;f+=3)I[f+1]+=Math.sin(C*.001+I[f]*.01)*.01;r.current.geometry.attributes.position.needsUpdate=!0,i.current.render(e.current,n.current)};return k(),()=>{var I,f,B;window.removeEventListener("resize",E),window.removeEventListener("mousemove",b),cancelAnimationFrame(C),i.current&&t.current&&t.current.removeChild(i.current.domElement),r.current&&e.current&&e.current.remove(r.current),(I=r.current)!=null&&I.geometry&&r.current.geometry.dispose(),(f=r.current)!=null&&f.material&&r.current.material.dispose(),(B=i.current)==null||B.dispose()}},[]),x.jsx("div",{ref:t,style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",zIndex:0,pointerEvents:"none"}})},Yb=()=>{const[t,e]=Nt.useState(0);return Nt.useEffect(()=>{const n=()=>{const i=document.documentElement.scrollHeight-document.documentElement.clientHeight,s=window.scrollY/i;e(s)};return window.addEventListener("scroll",n),n(),()=>window.removeEventListener("scroll",n)},[]),x.jsx("div",{className:"scroll-progress",style:{transform:`scaleX(${t})`}})},Kb=()=>(Nt.useEffect(()=>{MS.init({duration:800,once:!1,easing:"ease-out-cubic"})},[]),x.jsxs(x.Fragment,{children:[x.jsx($b,{}),x.jsx(Yb,{}),x.jsx(TS,{}),x.jsxs("main",{children:[x.jsx(bS,{}),x.jsx(AS,{}),x.jsx(CS,{}),x.jsx(RS,{}),x.jsx(DS,{}),x.jsx(LS,{}),x.jsx(IS,{}),x.jsx(US,{}),x.jsx(FS,{})]}),x.jsx(kS,{}),x.jsx(OS,{})]})),Zb=document.getElementById("root"),Qb=W_(Zb);Qb.render(x.jsx(Kb,{}));
