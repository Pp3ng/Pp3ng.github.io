 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(V,ce){var _e=V.length;V.push(ce);e:for(;0<_e;){var be=_e-1>>>1,Ge=V[be];if(0<r(Ge,ce))V[be]=ce,V[_e]=Ge,_e=be;else break e}}function n(V){return V.length===0?null:V[0]}function i(V){if(V.length===0)return null;var ce=V[0],_e=V.pop();if(_e!==ce){V[0]=_e;e:for(var be=0,Ge=V.length,st=Ge>>>1;be<st;){var oe=2*(be+1)-1,xe=V[oe],Ae=oe+1,ye=V[Ae];if(0>r(xe,_e))Ae<Ge&&0>r(ye,xe)?(V[be]=ye,V[Ae]=_e,be=Ae):(V[be]=xe,V[oe]=_e,be=oe);else if(Ae<Ge&&0>r(ye,_e))V[be]=ye,V[Ae]=_e,be=Ae;else break e}}return ce}function r(V,ce){var _e=V.sortIndex-ce.sortIndex;return _e!==0?_e:V.id-ce.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var a=Date,l=a.now();t.unstable_now=function(){return a.now()-l}}var u=[],d=[],v=1,m=null,g=3,y=!1,E=!1,A=!1,M=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,S=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function w(V){for(var ce=n(d);ce!==null;){if(ce.callback===null)i(d);else if(ce.startTime<=V)i(d),ce.sortIndex=ce.expirationTime,e(u,ce);else break;ce=n(d)}}function C(V){if(A=!1,w(V),!E)if(n(u)!==null)E=!0,fe(k);else{var ce=n(d);ce!==null&&me(C,ce.startTime-V)}}function k(V,ce){E=!1,A&&(A=!1,h(B),B=-1),y=!0;var _e=g;try{for(w(ce),m=n(u);m!==null&&(!(m.expirationTime>ce)||V&&!O());){var be=m.callback;if(typeof be=="function"){m.callback=null,g=m.priorityLevel;var Ge=be(m.expirationTime<=ce);ce=t.unstable_now(),typeof Ge=="function"?m.callback=Ge:m===n(u)&&i(u),w(ce)}else i(u);m=n(u)}if(m!==null)var st=!0;else{var oe=n(d);oe!==null&&me(C,oe.startTime-ce),st=!1}return st}finally{m=null,g=_e,y=!1}}var I=!1,f=null,B=-1,D=5,N=-1;function O(){return!(t.unstable_now()-N<D)}function q(){if(f!==null){var V=t.unstable_now();N=V;var ce=!0;try{ce=f(!0,V)}finally{ce?W():(I=!1,f=null)}}else I=!1}var W;if(typeof S=="function")W=function(){S(q)};else if(typeof MessageChannel<"u"){var ee=new MessageChannel,he=ee.port2;ee.port1.onmessage=q,W=function(){he.postMessage(null)}}else W=function(){M(q,0)};function fe(V){f=V,I||(I=!0,W())}function me(V,ce){B=M(function(){V(t.unstable_now())},ce)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(V){V.callback=null},t.unstable_continueExecution=function(){E||y||(E=!0,fe(k))},t.unstable_forceFrameRate=function(V){0>V||125<V?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<V?Math.floor(1e3/V):5},t.unstable_getCurrentPriorityLevel=function(){return g},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(V){switch(g){case 1:case 2:case 3:var ce=3;break;default:ce=g}var _e=g;g=ce;try{return V()}finally{g=_e}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(V,ce){switch(V){case 1:case 2:case 3:case 4:case 5:break;default:V=3}var _e=g;g=V;try{return ce()}finally{g=_e}},t.unstable_scheduleCallback=function(V,ce,_e){var be=t.unstable_now();switch(typeof _e=="object"&&_e!==null?(_e=_e.delay,_e=typeof _e=="number"&&0<_e?be+_e:be):_e=be,V){case 1:var Ge=-1;break;case 2:Ge=250;break;case 5:Ge=1073741823;break;case 4:Ge=1e4;break;default:Ge=5e3}return Ge=_e+Ge,V={id:v++,callback:ce,priorityLevel:V,startTime:_e,expirationTime:Ge,sortIndex:-1},_e>be?(V.sortIndex=_e,e(d,V),n(u)===null&&V===n(d)&&(A?(h(B),B=-1):A=!0,me(C,_e-be))):(V.sortIndex=Ge,e(u,V),E||y||(E=!0,fe(k))),V},t.unstable_shouldYield=O,t.unstable_wrapCallback=function(V){var ce=g;return function(){var _e=g;g=ce;try{return V.apply(this,arguments)}finally{g=_e}}}})(Xg);Wg.exports=Xg;var v0=Wg.exports;/**
 * @license React
...
`;Nt.useEffect(()=>{if(l(m),E()){const S=document.getElementById("terminal-output");S&&(S.style.fontSize="8px")}},[]),Nt.useEffect(()=>{A()},[a]);const g={help:()=>`Available commands:
...
<a href="mailto:pp3ng@outlook.com">Email: Pp3ng@outlook.com</a>`,clear:()=>(l(m),null),goto:S=>{const w=document.getElementById(S);if(w){const C=document.querySelector(".navbar"),k=(C==null?void 0:C.offsetHeight)||0;return window.scrollTo({top:w.offsetTop-k-20,behavior:"smooth"}),`Navigating to ${S}...`}else return`Section not found: ${S}. Available sections: about, terminal, journey, passions, gallery, projects, insights, bookshelf`},joke:()=>'<img src="https://readme-jokes.vercel.app/api?theme=vue" alt="Programming Joke" style="max-width: 100%; border-radius: 8px;">',cowsay:(S="Mooooo!")=>{const w=Array.isArray(S)?S.join(" "):S.toString();return`
  ${"-".repeat(w.length+2)}
< ${w} >
  ${"-".repeat(w.length+2)}
        \\   ^__^
