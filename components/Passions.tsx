        ...
        <div className="passion-item">
          ...
          <div className="passion-description">
            ...
            <p>
              ...
              I enjoy exploring different programming paradigms and technologies
              to create efficient solutions. Whether it's building
              high-performance systems, developing web applications, or working
              on data processing tools, I find great satisfaction in turning
        ...
        <div className="passion-item">
          ...
          <div className="passion-description">
            ...
            <p>
              ...
              light and shadow, while documenting the subtle beauty that
              surrounds us. Each frame tells its own story, whether it's the
              grandeur of architecture or the quiet moments in nature.
            </p>
          </div>
          <div className="passion-images">
            <img
